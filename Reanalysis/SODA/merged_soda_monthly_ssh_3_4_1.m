...
sodadir='/data2/kimyy/Reanalysis/SODA/SODA_3_4_1/';
sodaprefix='soda3.4.1_mn_ocean_reg_';
...
netcdf.putAtt(ncid,netcdf.getConstant('NC_GLOBAL'), ...
    'type', ' SODA 3.4.1 global monthly SSH merged file ');
netcdf.putAtt(ncid,netcdf.getConstant('NC_GLOBAL'), ...
    'title', ' Sea Surface Height, Mean Sea Level, Climatology SSH (1993-2012) ');
netcdf.putAtt(ncid,netcdf.getConstant('NC_GLOBAL'), ...
    'source', ' SODA 3.4.1 monthly average data with MOM5 driven by ERA-Interim forcing ');
netcdf.putAtt(ncid,netcdf.getConstant('NC_GLOBAL'), ...
