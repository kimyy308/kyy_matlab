...
ens_ocean_mod_heat2 = zeros(14,2,30);
...
% cshwa_num = [2,3,5,8,11,12,16,17,18,19,23,14,26,27,28,29,30,31,34,37,38,39,40,45]; % cshwa from model_name(sort_num)
% I : model performance
...
%save data
save(strcat(result_path,'/','processing_result_v2_heatcontent_NWP_csh3.mat'));
