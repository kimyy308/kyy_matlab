...
load(strcat(result_path,'/processing_result_v2_heatcontent_NWP.mat'));
...
%processing result file
load(strcat('/home/ygkim/ipcc/data/tos/new','/','processing_result_v2_tos_NWP.mat')); 
...
%processing result file
load(strcat('/home/ygkim/ipcc/data/zos/new','/','processing_result_v2_zos_NWP.mat'));
