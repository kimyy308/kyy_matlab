...
ens_ocean_mod_heat2 = zeros(41,2,30);
ens_ocean_RMSE2 = zeros(41,2);
ens_ocean_bias2 = zeros(41,2);
ens_ocean_trend_mod2 = zeros(41,2);
...
% sort_num = [7,9,12,16,18,20,21,22,25,26,29,34,35,36,38,39,41,42,43,45,47,48,49,50]; %cshwa
% I : model performance
%[sort_idx, sort_num] = sort(total_RMSE_new) ;   %set sort parameter
% ens_ocean_trend_mod2 = zeros(length(sort_num),2);
for k = 1:length(sort_num) %kyy
...
%save data
save(strcat(result_path,'/','processing_result_v2_heatcontent_NWP.mat'));
