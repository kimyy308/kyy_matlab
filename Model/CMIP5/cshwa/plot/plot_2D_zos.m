...
set(gca,'FontSize',14);
tt = strcat('SSHA - RMSE of ensemble model(each grid)');
...
m_pcolor(lon2,lat2,data);shading flat;
set(gca,'FontSize',14);
tt = strcat('SSHA - Bias of ensemble model(each grid)');
title(tt,'fontsize',20,'fontweight','bold');  
colorbar('EastOutSide');colormap jet;
axis tight;
saveas(gca,strcat('./figure/',tt,'.fig'),'fig');
...
m_pcolor(lon2,lat2,data);shading flat;
set(gca,'FontSize',14);
tt = strcat('SSHA - Trend of ensemble model(each grid)');
title(tt,'fontsize',20,'fontweight','bold');  
colorbar('EastOutSide');colormap jet;
...
set(gca,'FontSize',14);
tt = strcat('SSHA - Trend of observation(each grid)');
title(tt,'fontsize',20,'fontweight','bold');  
colorbar('EastOutSide');colormap jet;
axis tight;caxis([-0.1 0.1]*0.03);
saveas(gca,strcat('./figure/',tt,'.fig'),'fig');
...
%m_pcolor(xx,yy,data2);shading flat;
set(gca,'FontSize',14);
tt = strcat('SSHA - Trend difference of observation(each grid)');
title(tt,'fontsize',20,'fontweight','bold');  
colorbar('EastOutSide');colormap jet;
axis tight;%caxis([-0.1 0.1]*0.03);
saveas(gca,strcat('./figure/',tt,'.fig'),'fig');
