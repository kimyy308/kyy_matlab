...
%comment this average means 41 model's avg
...
in_index = [2,4,7,8,9,10,12,13,14,17,19,21,22,24];
in_index1 = [2,4,7,8,9];
in_index2 = [10,12,13,14,17];
in_index3 = [19,21,22,24];
...
bar(1:5,I(sort_num(csh_index(in_index1))),'BaseValue',0,'FaceColor','blue');
bar(6:10,I(sort_num(csh_index(in_index2))),'BaseValue',0,'FaceColor','red');
bar(11:14,I(sort_num(csh_index(in_index3))),'BaseValue',0,'FaceColor','green');
