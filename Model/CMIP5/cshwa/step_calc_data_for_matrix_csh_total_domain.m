...
mean_RMSE_OHC = mean(RMSE_OHC(sort_num(csh_index)));
mean_trend_OHC = mean(trend_OHC(sort_num(csh_index)));
mean_RMSE_SST = mean(RMSE_SST(sort_num(csh_index)));
mean_trend_SST = mean(trend_SST(sort_num(csh_index)));
mean_RMSE_SSH = mean(RMSE_SSH(sort_num(csh_index)));
mean_trend_SSH = mean(trend_SSH(sort_num(csh_index)));

save('mean_cshwa_24_total_domain.mat','mean_*');
