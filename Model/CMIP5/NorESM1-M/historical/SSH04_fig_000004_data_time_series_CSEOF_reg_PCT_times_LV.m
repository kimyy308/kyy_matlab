...
% var_names2 = {'psl', 'hur', 'rsds', 'zos'};  % var, psl, hur, rsds, ua, va
% var_names2 = {'ua', 'va'};  
...
for nvar2 = 1:length(var_names2)
    ...
    load([cseof_output_dir, '/reg_lv_layer_merge.mat']);
    var_name = var_names2{nvar2};
    
    mode = 3;
    %load cseof pc time series
    pct_data = importdata(tgt_cpct_tt)';
    pct = pct_data(:)';
    ...
    for i = 1 : mode
        ...
        tifname=[figure_output_dir, ...
            '/SSH_04_000004_NWP_reg_PCT_times_LV_time_series_mode_',num2str(i,'%02i'),'_', ...
