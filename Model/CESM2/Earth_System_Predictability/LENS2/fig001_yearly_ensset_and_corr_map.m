...
cfg.vars={'HMXL', 'photoC_TOT_zint_100m', 'HBLT', 'IRON_FLUX'};
% abc=dir('/Volumes/kyy_raid/kimyy/Model/CESM2/ESP/LENS2/archive_yearly_analysis/ocn')
% cfg.vars=abc(3:end).name;
% 
% cfg.obs={'en4.2_ba', 'projdv7.3_ba'};
for vari= 1:length(cfg.vars)
    name.var=cfg.vars{vari};
    dirs.assmroot=['/Volumes/kyy_raid/kimyy/Model/CESM2/ESP/LENS2/archive_yearly_analysis/ocn/', name.var];
    dirs.figroot=['/Volumes/kyy_raid/kimyy/Figure/CESM2/ESP/LENS2/archive_yearly_analysis/ocn/', name.var];
...
%             tmp.C(tmp.C<1)=1;
            ...
            if tmp.maxC>=1
                fig_cfg=fig_param_set('yr', [1 tmp.maxC], tmp.dropboxpath);  % cmap, clim, droppath
            else
                fig_cfg=fig_param_set('gray', [tmp.minC tmp.maxC], tmp.dropboxpath);  % cmap, clim, droppath
            end
...
% 
%             if (fig_cfg.c_lim(1) ==1 & fig_cfg.c_lim(2) ==1)
