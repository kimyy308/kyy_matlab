    ...
    if (exist(cfg.svnm)==0 && t.er_s~=1)
        ...
        switch t.cmp
            case 'ocn'
                ...
                lev_dimid = netcdf.defDim(ncid,'z_t', CESM2_grid.l_y);
            case {'atm', 'lnd', 'rof'}
                lon_dimid = netcdf.defDim(ncid, 'lon', CESM2_grid.l_x);
                lat_dimid = netcdf.defDim(ncid, 'lat', CESM2_grid.l_y);
                lev_dimid = netcdf.defDim(ncid,'lev', CESM2_grid.l_y);
        end
...
%             netcdf.putAtt(ncid,timevarid,'bounds','time_bound');           
        ...
        switch t.cmp
            case {'ocn'}
                levvarid = netcdf.defVar(ncid, 'z_t', 'NC_DOUBLE', lon_dimid);
            ...
            case {'atm', 'lnd', 'rof'}
                ...
                levvarid = netcdf.defVar(ncid, 'lev', 'NC_DOUBLE', lon_dimid);
