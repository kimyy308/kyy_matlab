...
%     corrval_hcst.assm_hcst.ly1.val_median
    ...
    for loni=1:size(autocorr_i2,1)
        for lati=1:size(autocorr_i2,2)
            autocorr2(loni,lati)=autocorr_i2(loni,lati);
        end
    end
...
%     corrval_hcst.assm_hcst.ly1.val_median
    ...
    for reci=1:length(corrval_assm.grid.valid_ind)
        ...
        recasted_idx_oda(corrval_assm.grid.valid_ind_i(reci), corrval_assm.grid.valid_ind_j(reci)) = ceil(tmp.a_idx/50);
    end
    ...
    autocorrfile1=[dirs.autocorrroot, '/', 'autocorr_', cfg.var, '_ODA.nc'];
    autocorr_i1=ncread(autocorrfile1, cfg.var);
    autocorr1=NaN(size(recasted_idx_oda));
    for loni=1:size(autocorr_i1,1)
        for lati=1:size(autocorr_i1,2)
            if recasted_idx_oda(loni,lati)>0
                autocorr1(loni,lati)=autocorr_i1(loni,lati,recasted_idx_oda(loni,lati));
...
%     corrval_hcst.assm_hcst.ly1.val_median
    ...
    recasted_idx_oda=NaN(size(grid.tlong));
    for reci=1:length(corrval_assm.grid.valid_ind)
    ...
    autocorrfile1=[dirs.autocorrroot, '/', 'autocorr_', cfg.var, '_ODA.nc'];
    autocorr_i1=ncread(autocorrfile1, cfg.var);
    autocorr1=NaN(size(recasted_idx_lens2));
    for loni=1:size(autocorr_i1,1)
        for lati=1:size(autocorr_i1,2)
            if recasted_idx_oda(loni,lati)>0
                autocorr1(loni,lati)=autocorr_i1(loni,lati,recasted_idx_oda(loni,lati));
...
for subi=1:1
    ...
    autocorrfile1=[dirs.autocorrroot, '/', 'autocorr_', cfg.var, '_HCST_em.nc'];
    autocorr1=ncread(autocorrfile1, cfg.var);
    ...
    for reci=1:length(corrval_assm.grid.valid_ind)
        ...
        autocorr_oda_tmp=autocorr_oda(corrval_assm.grid.valid_ind_i(reci), corrval_assm.grid.valid_ind_j(reci), tmp.a_idx_hc);
        autocorr1_tmp = autocorr1(corrval_assm.grid.valid_ind_i(reci), corrval_assm.grid.valid_ind_j(reci));
        sig_n_star1=sig_n.*(1-autocorr_oda_tmp .* autocorr1_tmp)./(1+autocorr_oda_tmp.*autocorr1_tmp);
        sig_n_star1(sig_n_star1<=2)=NaN;
        ...
        autocorr_oda_tmp=autocorr_oda(corrval_assm.grid.valid_ind_i(reci), corrval_assm.grid.valid_ind_j(reci), tmp.b_idx_le);
        autocorr2_tmp=autocorr2(corrval_assm.grid.valid_ind_i(reci), corrval_assm.grid.valid_ind_j(reci));        
        sig_n_star2=sig_n.*(1-autocorr_oda_tmp.*autocorr2_tmp)./(1+autocorr_oda_tmp.*autocorr2_tmp);
        sig_n_star2(sig_n_star2<=2)=NaN;
...
%     set(MyBox,'String','Burned Area')
    ...
    cfg.figname=['/Volumes/kyy_raid/kimyy/Research/Postdoc/03_IBS/2022_predictability_assimilation_run/paper', ...
        filesep, 'Figureset_raw', filesep, 'eDOF2_Siegert_title_fig1','_v2_',cfg.var, '.tif'];
    ...
    cfg.figname2=['/Volumes/kyy_raid/kimyy/Research/Postdoc/03_IBS/2022_predictability_assimilation_run/paper', ...
        filesep, 'Figureset_raw', filesep, 'eDOF2_Siegert_title_fig1','_v2_',cfg.var, '.eps'];
