...
%% figure start
fig_cfg.fig_size = [0,0,19,19.5]; %% paper size (original)
% fig_cfg.fig_size = [0,0,19,14.5]; %% paper size (original)
% fig_cfg.cb_size = [1, 13, 17, 0.3];
fig_cfg.cb_size = [1, 16.5, 17, 0.3];
loc_column_first=1;
loc_row_first=7+4;
...
caxis([0 max(period)/100]);
fig_cfg.ax_size = [loc_column_first, loc_row_first-5.5, 17, 4.5];
...
%% plots by ensemble members
ax_m_8=subplot(8,8,8);
fig_cfg.ax_size = [loc_column_first, loc_row_first-10, 16.3, 4];
...
skills_em2(13,:)=skills_em(25,:);
skills_em2(14,:)=skills_em(30,:);
skills_em2(15,:)=skills_em(35,:);
skills_em2(16,:)=skills_em(40,:);
skills_em2(17,:)=skills_em(45,:);
skills_em2(18,:)=skills_em(50,:);
skills_em2(19,:)=skills_em(60,:);
skills_em2(20,:)=skills_em(70,:);
skills_em2(21,:)=skills_em(80,:);
skills_em2(22,:)=skills_em(90,:);
skills_em2(23,:)=skills_em(100,:);

skills_ri_med2(1:10,:)=skills_ri_med(1:10,:);
skills_ri_med2(11,:)=skills_ri_med(15,:);
skills_ri_med2(12,:)=skills_ri_med(20,:);
skills_ri_med2(13,:)=skills_ri_med(25,:);
skills_ri_med2(14,:)=skills_ri_med(30,:);
skills_ri_med2(15,:)=skills_ri_med(35,:);
skills_ri_med2(16,:)=skills_ri_med(40,:);
skills_ri_med2(17,:)=skills_ri_med(45,:);
skills_ri_med2(18,:)=skills_ri_med(50,:);
skills_ri_med2(19,:)=skills_ri_med(60,:);
skills_ri_med2(20,:)=skills_ri_med(70,:);
skills_ri_med2(21,:)=skills_ri_med(80,:);
skills_ri_med2(22,:)=skills_ri_med(90,:);
skills_ri_med2(23,:)=skills_ri_med(100,:);

% bp1=boxplot(skills_em2', [1:10,15:5:50,60:10:100], 'BoxStyle', 'outline', 'symbol', '', 'Whisker', 2);
% bp1=boxplot(skills_em2', [1:10,15:5:50,60:10:100], 'PlotStyle', 'compact');
bp1=boxchart(skills_em2', 'MarkerStyle','none');
bp1.BoxFaceColor='red';
% set(bp1, {'linew'}, {1.5})
hold on
% bp2=boxplot(skills_ri_med2', [1:10,15:5:50,60:10:100], 'BoxStyle', 'outline', 'symbol', '', 'Whisker', 2);
% set(bp2, {'linew'}, {1.5})
bp2=boxchart(skills_ri_med2', 'MarkerStyle','none');
bp2.BoxFaceColor='blue';

xlabel('# of used ensemble');
ylabel('ACC for $$ x(\tau=2.0) $$', 'Interpreter', 'latex', 'fontsize', 25.*fig_weig)
set(ax_m_8, 'Ylim',[0.2 0.5])
set(ax_m_8,'fontsize',15);
set(ax_m_8,'YAxisLocation', 'right');
set(ax_m_8, 'Xticklabel', [1:10,15:5:50,60:10:100])
grid on

[hLg]=legend(ax_m_8, [bp1, bp2], ...
    {'ensmean', 'individual'}, ...
    'Location', 'southeast', ...
    'Fontsize', 15.*fig_weig);  %% for median
