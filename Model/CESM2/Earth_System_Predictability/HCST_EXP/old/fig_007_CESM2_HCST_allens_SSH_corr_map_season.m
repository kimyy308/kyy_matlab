...
dirs.obsroot=['/Volumes/kyy_raid/kimyy/Observation/CMEMS/monthly_reg_pop'];
dirs.figroot=['/Volumes/kyy_raid/kimyy/Figure/CESM2/ESP/HCST_EXP/archive/ocn/', cfg.var];

cfg.iyears=1993:2020;
% cfg.months=1:12;
% cfg.scnm='HIST';
cfg.gnm='f09_g17';
% cfg.assm_factor='10';
...
%         tmp.fy_str=num2str(tmp.fy, '%04i');
        ...
        for mon=1:length(tmp.mons)
            ...
            cfg.obs_fnm=[dirs.obsroot, tmp.fs, 'CMEMS_reg_cesm2.',tmp.fy_str,tmp.mon_str, '.nc'];
            tmp.sdata_obs(:,:,mon)=ncread(cfg.obs_fnm, 'sla');
