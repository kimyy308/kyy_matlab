...
%             cfg.obs_fnm=[dirs.obsroot, tmp.fs, 'ersst_reg_cesm2.v5.',tmp.fy_str,tmp.mon_str, '.nc'];
            cfg.obs_fnm=[dirs.obsroot, tmp.fs, 'ERA5_', cfg.obs_var, '_reg_cesm2.',tmp.fy_str,tmp.mon_str, '.nc'];  %read as iyear, plot as +lyear
            tmp.sdata_obs(:,:,mon)=ncread(cfg.obs_fnm, cfg.obs_var);
        end
