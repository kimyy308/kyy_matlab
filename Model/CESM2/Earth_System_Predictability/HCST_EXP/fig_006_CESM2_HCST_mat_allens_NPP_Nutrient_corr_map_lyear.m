...
[maxval, maxind] = max(norm_corrset, [], 3);
maxind(isnan(data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04))=NaN;
...
tmp.norm_corr= data_Fe.sp_Fe_lim_Cweight_avg_100m_corr_assm_int_l04;
tmp.norm_corr(data_Fe.sp_Fe_lim_Cweight_avg_100m_corr_assm_int_l04<0.2) = NaN;
tmp.norm_corr= tmp.norm_corr ./ ...
    data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04;
norm_corrset(:,:,1)=tmp.norm_corr;

tmp.norm_corr= data_NO3.sp_N_lim_Cweight_avg_100m_corr_assm_int_l04;
tmp.norm_corr(data_NO3.sp_N_lim_Cweight_avg_100m_corr_assm_int_l04<0.2) = NaN;
tmp.norm_corr= tmp.norm_corr ./ ...
    data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04;
norm_corrset(:,:,2)=tmp.norm_corr;

% tmp.norm_corr= data_SiO3.sp_SiO3_lim_Cweight_avg_100m_corr_assm_int_l04;
% tmp.norm_corr(data_SiO3.sp_SiO3_lim_Cweight_avg_100m_corr_assm_int_l04<0.2) = NaN;
% tmp.norm_corr= tmp.norm_corr ./ ...
%     data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04;
% norm_corrset(:,:,3)=tmp.norm_corr;
norm_corrset(:,:,3)=NaN;

tmp.norm_corr= data_PO4.sp_P_lim_Cweight_avg_100m_corr_assm_int_l04;
tmp.norm_corr(data_PO4.sp_P_lim_Cweight_avg_100m_corr_assm_int_l04<0.2) = NaN;
tmp.norm_corr= tmp.norm_corr ./ ...
    data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04;
norm_corrset(:,:,4)=tmp.norm_corr;
