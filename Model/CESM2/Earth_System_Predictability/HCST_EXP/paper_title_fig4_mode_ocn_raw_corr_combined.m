...
% % %     tmp.C=squeeze(recasted_val_hcst);
    ...
    corrval_lens2.assm_lens2.val_mode=NaN(size(corrval_hcst.assm_hcst_em.ly1.val));
    for reci=1:size(corrval_hcst.assm_hcst.ly1.val, 2)
        corrval_lens2.assm_lens2.val_mode(corrval_assm.grid.valid_ind_i(reci), corrval_assm.grid.valid_ind_j(reci)) = ...
...
%     fig_cfg.fig_size = [0,0,13,14]; %% paper size (original)
    ...
    corrval_lens2.assm_lens2_4ym.val_mode=NaN(size(corrval_hcst.assm_hcst_em.ly1.val));
    for reci=1:size(corrval_hcst.assm_hcst.ly1.val, 2)
        corrval_lens2.assm_lens2_4ym.val_mode(corrval_assm.grid.valid_ind_i(reci), corrval_assm.grid.valid_ind_j(reci)) = ...
...
%     if ~exist(dirs.figdir,'dir'), mkdir(dirs.figdir); end
    cfg.figname=['/Volumes/kyy_raid/kimyy/Research/Postdoc/03_IBS/2022_predictability_assimilation_run/paper', ...
        filesep, 'Figureset_raw', filesep, 'title_fig4','_mode_OCN_comb', '.tif'];
    ...
    cfg.figname2=['/Volumes/kyy_raid/kimyy/Research/Postdoc/03_IBS/2022_predictability_assimilation_run/paper', ...
        filesep, 'Figureset_raw', filesep, 'title_fig4','_mode_OCN_comb', '.eps'];
