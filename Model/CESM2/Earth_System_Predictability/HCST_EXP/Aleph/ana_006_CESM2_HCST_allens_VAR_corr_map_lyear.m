        ...
        for iyear=min(cfg.iyears):max(cfg.iyears)
            ...
            for mon=1:12
                ...
                try
                    ...
                    disp(['csh ', '/mnt/lustre/proj/kimyy/Scripts/Model/CESM2/HCST/', 'hcst_extract_fix_matlab_ocn_var.csh ', ...
                        tmp.varname, ' ', num2str(length(tmp.dimids)-1), ' ', tmp.iyear_str, ' ', tmp.fy_str, ' ', tmp.mon_str]);
                     disp(['csh ', '/mnt/lustre/proj/kimyy/Scripts/Model/CESM2/HCST/', 'hcst_ens_fix_matlab.csh ', ...
                        tmp.varname, ' ', tmp.iyear_str, ' ', tmp.fy_str, ' ', tmp.mon_str]);
                      system(['csh ', '/mnt/lustre/proj/kimyy/Scripts/Model/CESM2/HCST/', 'hcst_extract_fix_matlab_ocn_var.csh ', ...
                        tmp.varname, ' ', num2str(length(tmp.dimids)-1), ' ', tmp.iyear_str, ' ', tmp.fy_str, ' ', tmp.mon_str]);
