...
% cfg.vars = {'SST'};
cfg.vars={'photoC_TOT_zint_100m'};
cfg.vars={'tend_zint_100m_NO3', 'subt_tend_zint_100m_NO3_Jint_100m_NO3', 'Jint_100m_NO3', 'NO3'};
% cfg.vars={'NO3'};
cfg.vars={'photoC_TOT_zint_100m'};
cfg.vars={'zooC'};
...
for lyear=0:cfg.proj_year-1
    ...
    for loni=1:size(data2_all.l00.([tmp.varname,'_corr_assm_int_ano_l00']), 1)
        for lati=1:size(data2_all.l00.([tmp.varname,'_corr_assm_int_ano_l00']), 2)
            if (data2_all.(['l',tmp.lyear_str]).([tmp.varname,'_corr_assm_int_ano_l',tmp.lyear_str])(loni,lati)>=0 && ...
                    data2_all.(['l',tmp.lyear_str]).([tmp.varname,'_corr_assm_int_ano_p_l',tmp.lyear_str])(loni,lati) <=0.05)
...
cfg.figname=[dirs.figdir, filesep, 'pred_hor_int_ano_map_', tmp.varname, '.tif'];
