...
for subi=1:1
    ...
    recasted_val_lens2_raw=NaN(1000,size(corrval_hcst.assm_hcst_em.ly1.val,1), size(corrval_hcst.assm_hcst_em.ly1.val,2));
    corrval_lens2.assm_lens2.val_median=median(corrval_lens2.assm_lens2.val, 1);
    recasted_val_lens2=NaN(size(corrval_lens2.assm_lens2_em.val));
    for reci=1:length(corrval_assm.grid.valid_ind)
        recasted_val_lens2(corrval_assm.grid.valid_ind_i(reci), corrval_assm.grid.valid_ind_j(reci))= ...
            corrval_lens2.assm_lens2.val_median(1,reci);
        recasted_val_lens2_raw(:,corrval_assm.grid.valid_ind_i(reci), corrval_assm.grid.valid_ind_j(reci))=corrval_lens2.assm_lens2.val(:,reci);
    end
...
% corrval_lens2.assm_lens2.val
    
    tmp.A=corrval_lens2.assm_lens2_em.val;
...
for subi=1:1
    ...
    recasted_val_hcst_raw=NaN(400,size(corrval_hcst.assm_hcst_em.ly1.val,1), size(corrval_hcst.assm_hcst_em.ly1.val,2));
    corrval_hcst.assm_hcst.ly1.val_median=median(corrval_hcst.assm_hcst.ly1.val, 1);
    ...
    for reci=1:length(corrval_assm.grid.valid_ind)
        ...
        recasted_val_hcst_raw(:,corrval_assm.grid.valid_ind_i(reci), corrval_assm.grid.valid_ind_j(reci))=corrval_hcst.assm_hcst.ly1.val(:,reci);
    end
...
%     cb = colorbar(ax_m,'units','inches','Location', 'southoutside', 'position',fig_cfg.cb_size + [0 0 0 0]);
    ...
    cfg.figname=['/Users/kimyy/Desktop/backup/Research/Postdoc/03_IBS/2022_predictability_assimilation_run/paper', ...
        filesep, 'Figureset_raw', filesep, 'fig3','_lnd_overestim', '.tif'];
