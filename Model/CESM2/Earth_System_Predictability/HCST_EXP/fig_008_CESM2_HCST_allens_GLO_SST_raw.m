...
dirs.assmroot=['/Volumes/kyy_raid/kimyy/Model/CESM2/ESP/ASSM_EXP/archive_transfer/atm/', cfg.var];
...
cfg.figname=[dirs.figdir, filesep, 'spaghetti_anom_', 'SST_hcst_all_', str.iy_min, '-', str.iy_max,'_proj_',num2str(cfg.proj_year),  'y.tif'];
