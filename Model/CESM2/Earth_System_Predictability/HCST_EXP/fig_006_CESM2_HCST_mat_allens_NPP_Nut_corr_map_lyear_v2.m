% %  Created 22-May-2023 by Yong-Yub Kim
...
% %         if (data_Fe.(['diat_Fe_lim_Cweight_avg_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati)>=0.2 && ...
% %                 data_NPP.(['photoC_TOT_zint_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati) >=0.2 )
% %             
...
% % for loni=1:size(grid.tlong,1)
% %     for lati=1:size(grid.tlat,2)
% %         if (data_NO3.(['diat_N_lim_Cweight_avg_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati)>=0.2 && ...
% %                 data_NPP.(['photoC_TOT_zint_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati) >=0.2 )
% %             
% %             [tmp.corr, tmp.corr_p]= corrcoef(data_NPP.(['photoC_TOT_zint_100m_model_l',tmp.lyear_str])(loni,lati,:), ...
...
% % for loni=1:size(grid.tlong,1)
% %     for lati=1:size(grid.tlat,2)
% %         if (data_SiO3.(['diat_SiO3_lim_Cweight_avg_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati)>=0.2 && ...
% %                 data_NPP.(['photoC_TOT_zint_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati) >=0.2 )
% %             
% %             [tmp.corr, tmp.corr_p]= corrcoef(data_NPP.(['photoC_TOT_zint_100m_model_l',tmp.lyear_str])(loni,lati,:), ...
...
% % for loni=1:size(grid.tlong,1)
% %     for lati=1:size(grid.tlat,2)
% %         if (data_PO4.(['diat_P_lim_Cweight_avg_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati)>=0.2 && ...
% %                 data_NPP.(['photoC_TOT_zint_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati) >=0.2 )
% %             
% %            [tmp.corr, tmp.corr_p]= corrcoef(data_NPP.(['photoC_TOT_zint_100m_model_l',tmp.lyear_str])(loni,lati,:), ...
...
% % %  % normalize
% % % data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04(data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04<0.2)=NaN;
% % % 
% % % tmp.norm_corr= data_Fe.diat_Fe_lim_Cweight_avg_100m_corr_assm_int_l04;
% % % tmp.norm_corr(data_Fe.diat_Fe_lim_Cweight_avg_100m_corr_assm_int_l04<0.2) = NaN;
% % % tmp.norm_corr= tmp.norm_corr ./ ...
% % %     data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04;
% % % norm_corrset(:,:,1)=tmp.norm_corr;
% % % 
% % % tmp.norm_corr= data_NO3.diat_N_lim_Cweight_avg_100m_corr_assm_int_l04;
% % % tmp.norm_corr(data_NO3.diat_N_lim_Cweight_avg_100m_corr_assm_int_l04<0.2) = NaN;
% % % tmp.norm_corr= tmp.norm_corr ./ ...
% % %     data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04;
% % % norm_corrset(:,:,2)=tmp.norm_corr;
% % % 
% % % tmp.norm_corr= data_SiO3.diat_SiO3_lim_Cweight_avg_100m_corr_assm_int_l04;
% % % tmp.norm_corr(data_SiO3.diat_SiO3_lim_Cweight_avg_100m_corr_assm_int_l04<0.2) = NaN;
% % % tmp.norm_corr= tmp.norm_corr ./ ...
% % %     data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04;
% % % norm_corrset(:,:,3)=tmp.norm_corr;
% % % 
% % % tmp.norm_corr= data_PO4.diat_P_lim_Cweight_avg_100m_corr_assm_int_l04;
% % % tmp.norm_corr(data_PO4.diat_P_lim_Cweight_avg_100m_corr_assm_int_l04<0.2) = NaN;
% % % tmp.norm_corr= tmp.norm_corr ./ ...
% % %     data_NPP.photoC_TOT_zint_100m_corr_assm_int_l04;
% % % norm_corrset(:,:,4)=tmp.norm_corr;
...
%     title(cb,'R','fontsize',12);
    ...
    cfg.figname=[dirs.figdir, filesep, 'dominant_nut_diat', '_l', tmp.lyear_str, 'y.tif'];
...
%     title(cb,'R','fontsize',12);
    ...
    dirs.figdir= [dirs.figroot, filesep, cfg.casename_m, filesep, cfg.var, '_dominant_N'];
    if ~exist(dirs.figdir,'dir'), mkdir(dirs.figdir); end
    cfg.figname=[dirs.figdir, filesep, 'dominant_nut_diat_corr', '_l', tmp.lyear_str, 'y.tif'];
    print(fig_h, cfg.figname, '-dpng');
    RemoveWhiteSpace([], 'file', cfg.figname);
    close all;
...
% % for loni=1:size(grid.tlong,1)
% %     for lati=1:size(grid.tlat,2)
% %         if (data_Fe.(['sp_Fe_lim_Cweight_avg_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati)>=0.2 && ...
% %                 data_NPP.(['photoC_TOT_zint_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati) >=0.2 )
% %             
% %             [tmp.corr, tmp.corr_p]= corrcoef(data_NPP.(['photoC_TOT_zint_100m_model_l',tmp.lyear_str])(loni,lati,:), ...
...
% % for loni=1:size(grid.tlong,1)
% %     for lati=1:size(grid.tlat,2)
% %         if (data_NO3.(['sp_N_lim_Cweight_avg_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati)>=0.2 && ...
% %                 data_NPP.(['photoC_TOT_zint_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati) >=0.2 )
% %             
% %             [tmp.corr, tmp.corr_p]= corrcoef(data_NPP.(['photoC_TOT_zint_100m_model_l',tmp.lyear_str])(loni,lati,:), ...
...
% % for loni=1:size(grid.tlong,1)
% %     for lati=1:size(grid.tlat,2)
% %         if (data_PO4.(['sp_P_lim_Cweight_avg_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati)>=0.2 && ...
% %                 data_NPP.(['photoC_TOT_zint_100m_corr_assm_int_l', tmp.lyear_str])(loni,lati) >=0.2 )
% %             
% %            [tmp.corr, tmp.corr_p]= corrcoef(data_NPP.(['photoC_TOT_zint_100m_model_l',tmp.lyear_str])(loni,lati,:), ...
...
%% frame and label setting
    ...
    dirs.figdir= [dirs.figroot, filesep, cfg.casename_m, filesep, cfg.var, '_dominant_N'];
    if ~exist(dirs.figdir,'dir'), mkdir(dirs.figdir); end
    cfg.figname=[dirs.figdir, filesep, 'dominant_nut_sp', '_l', tmp.lyear_str, 'y.tif'];
    print(fig_h, cfg.figname, '-dpng');
    RemoveWhiteSpace([], 'file', cfg.figname);
    close all;
...
%     title(cb,'R','fontsize',12);
    ...
    dirs.figdir= [dirs.figroot, filesep, cfg.casename_m, filesep, cfg.var, '_dominant_N'];
    if ~exist(dirs.figdir,'dir'), mkdir(dirs.figdir); end
    cfg.figname=[dirs.figdir, filesep, 'dominant_nut_sp_corr', '_l', tmp.lyear_str, 'y.tif'];
    print(fig_h, cfg.figname, '-dpng');
    RemoveWhiteSpace([], 'file', cfg.figname);
    close all;
