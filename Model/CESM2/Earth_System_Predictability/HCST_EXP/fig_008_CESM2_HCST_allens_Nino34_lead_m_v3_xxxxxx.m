...
%     tmp.assmvar = ['nino34m_', tmp.varname, '_assm_',  '_i', tmp.iyear_str];
    ...
    for fy = iyear:iyear+cfg.proj_year-1
        ...
        for mon=1:12
            ...
            %% make anomaly here
            data.(tmp.modelvar)= data.(tmp.modelvar) - mean(data.(tmp.modelvar), 'omitnan');  
            ...
            %% make anomaly here            
            data.(tmp.obsvar) = data.(tmp.obsvar) - mean(data.(tmp.obsvar), 'omitnan');
        end
    end
...
%     tmp.assmvar_ano_lm=['nino34m_', tmp.varname, '_assm_ano_',  '_l', tmp.lmonth_str];
    ...
    data.(tmp.modelvar_ano_lm)=data.(tmp.modelvar_lm);
...
%         tmp.tind= (cfg.iyears-min(cfg.iyears))*12+1+lmonth;
    ...
    cfg.figname=[dirs.figdir, filesep, 'nino34m_v3_hcst_obs_',str.iy_min, '-', str.iy_max, 'm', '_corr_leadm', '.tif'];
%             bar(0:cfg.proj_year*12-1,data.(['nino34m_', tmp.varname, '_corr']),  'linewidth', 2)
    ...
    cfg.figname=[dirs.figdir, filesep, 'nino34m_v3_hcst_obs_Elnino_',str.iy_min, '-', str.iy_max, 'm', '_corr_leadm', '.tif'];
    ...
    cfg.figname=[dirs.figdir, filesep, 'nino34m_v3_hcst_obs_Lanina_',str.iy_min, '-', str.iy_max, 'm', '_corr_leadm', '.tif'];
    ...
    cfg.figname=[dirs.figdir, filesep, 'nino34m_v3_hcst_obs_Neutral_',str.iy_min, '-', str.iy_max, 'm', '_corr_leadm', '.tif'];
    ...
    cfg.figname=[dirs.figdir, filesep, 'nino34m_v3_hcst_obs_All_',str.iy_min, '-', str.iy_max, 'm', '_corr_leadm', '.tif'];
    ...
    cfg.figname=[dirs.figdir, filesep, 'nino34m_v3_hcst_obs_',str.iy_min, '-', str.iy_max, 'm', '_nRMSE_leadm', '.tif'];
    ...
    cfg.figname=[dirs.figdir, filesep, 'nino34m_v3_hcst_obs_',str.iy_min, '-', str.iy_max, 'm', '_nRMSE_Elnino_leadm', '.tif'];
    ...
    cfg.figname=[dirs.figdir, filesep, 'nino34m_v3_hcst_obs_',str.iy_min, '-', str.iy_max, 'm', '_nRMSE_Lanina_leadm', '.tif'];
    ...
    cfg.figname=[dirs.figdir, filesep, 'nino34m_v3_hcst_obs_',str.iy_min, '-', str.iy_max, 'm', '_nRMSE_All_leadm', '.tif'];
...
% end
    ...
    cfg.figname=[dirs.figdir, filesep, 'SMYLE_nino34m_v3_hcst_obs_',str.iy_min, '-', str.iy_max, 'm', '_corr_leadm', '.tif'];
%             bar(0:cfg.proj_year*12-1,data.(['nino34m_', tmp.varname, '_corr']),  'linewidth', 2)
    ...
    cfg.figname=[dirs.figdir, filesep, 'SMYLE_nino34m_v3_hcst_obs_',str.iy_min, '-', str.iy_max, 'm', '_nRMSE_leadm', '.tif'];
%             bar(0:cfg.proj_year*12-1,data.(['nino34m_', tmp.varname, '_corr']),  'linewidth', 2)
...
hold off
axis tight
cfg.figname=[dirs.figdir, filesep, 'spaghetti_nino34m_v3_hcst_obs_oneline', '_', str.iy_min, '-', str.iy_max, '_leadm', '.tif'];
...
grid minor
set(gcf, 'PaperPosition', [0, 0, 8, 4]);
cfg.figname=[dirs.figdir, filesep, 'spaghetti_v3_', 'SST_hcst_obs_', str.iy_min, '-', str.iy_max,'_proj_',cfg.proj_year,  'y.tif'];
saveas(gcf,cfg.figname,'tif');
RemoveWhiteSpace([], 'file', cfg.figname);
close all;
