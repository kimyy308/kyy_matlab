    ...
    for loni=1:size(corrval_hcst.assm_hcst_em.ly1.val,1)
        for lati=1:size(corrval_hcst.assm_hcst_em.ly1.val,2)
            [tmp.hc_corr,tmp.hc_p,tmp.hc_rl,tmp.hc_ru] = ...
                ...
                corrval_assm.data.([cfg.var,'_ym'])(loni,lati,:),'alpha', 0.10);
            [tmp.le_corr,tmp.le_p,tmp.le_rl,tmp.le_ru] = ...
                corrcoef(corrval_assm.data.([cfg.var,'_ym'])(loni,lati,:), ...
...
%             end
            tmp.hc_rnd=tmp.hc_corr(1,2)+(rand(1,400)-0.5).*2.*(tmp.hc_sigma(1,2));
            tmp.le_rnd=tmp.le_corr(1,2)+(rand(1,1000)-0.5).*2.*(tmp.le_sigma(1,2));
...
%     tmp.C(tmp.p>0.1)=NaN; % 90% significant
    ...
    fig_cfg.fig_name='$$ (i) \hspace{1mm}  r_{A,E(I)}^{\tau=1} $$';
...
%     tmp.C(tmp.p2>0.1)=NaN;
    ...
    fig_cfg.fig_name='$$ (j) \hspace{1mm}  r_{A,E(I)}^{\tau=1} -  r_{A,E(U)}^{\tau=1} $$';
...
for subi=1:1
    ...
    % normal distributed sample -> ttest
    for loni=1:size(corrval_hcst.assm_hcst_em_4ym.val,1)
        for lati=1:size(corrval_hcst.assm_hcst_em_4ym.val,2)
            [tmp.hc_corr,tmp.hc_p,tmp.hc_rl,tmp.hc_ru] = ...
                corrcoef(corrval_hcst.data.([cfg.var,'_4ym'])(loni,lati,:), ...
                corrval_assm.data.([cfg.var,'_4ym'])(loni,lati,:),'alpha', 0.10);
            [tmp.le_corr,tmp.le_p,tmp.le_rl,tmp.le_ru] = ...
                corrcoef(corrval_assm.data.([cfg.var,'_4ym'])(loni,lati,:), ...
                corrval_lens2.data.([cfg.var,'_4ym'])(loni,lati,:), 'alpha', 0.10);
            tmp.hc_sigma=(tmp.hc_ru-tmp.hc_rl)/2;
            tmp.le_sigma=(tmp.le_ru-tmp.le_rl)/2;
%             for i=1:100
%                 tmp.hc_rnd(i)=normrnd(tmp.hc_corr(1,2),tmp.hc_sigma(1,2));
...
%     tmp.C(tmp.p>0.1)=NaN; % 90% significant
    ...
    fig_cfg.fig_name='$$ (g) \hspace{1mm}  r_{A,E(I)}^{\tau=2 \textendash 5} $$';
...
%     tmp.C(tmp.p2>0.1)=NaN;
    ...
    fig_cfg.fig_name='$$ (h) \hspace{1mm}  r_{A,E(I)}^{\tau=2 \textendash 5} -  r_{A,E(U)}^{\tau=2 \textendash 5} $$';
...
%     tmp.C(tmp.p>0.1)=NaN; % 90% significant
    ...
    fig_cfg.fig_name='$$ (k) \hspace{1mm}  r_{A,E(I)}^{\tau=2 \textendash 5} $$';
...
%     tmp.C(tmp.p2>0.1)=NaN;
    ...
    fig_cfg.fig_name='$$ (l) \hspace{1mm}  r_{A,E(I)}^{\tau=2 \textendash 5} -  r_{A,E(U)}^{\tau=2 \textendash 5} $$';
