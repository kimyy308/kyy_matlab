...
dirs.svr='/mnt/lustre/proj/kimyy/Model/CESM2/ESP/ASSM_EXP/surface';  %dirs.saveroot
...
for vind=1:length(cfg.v)
    ...
    %     for eind=1:2
            ...
            t.dl=dir([dirs.r, '/*', t.onm, '-', t.ens, '*/', t.cmp, '/proc/tseries/month_1/*.', t.v, '.*']); %dir information list
