...
%     inputdir = ['D:\Data\Model\ROMS\nwp_1_20\', testname, '\run\']; %% for Desktop
    inputdir = ['/data2/RCM/CMIP6/Model/ROMS/nwp_1_20/output/monthly/', testname, '/run/packed_monthly/', num2str(year), '/']; %% for Desktop

    outputdir = ['/data2/RCM/CMIP6/Model/ROMS/nwp_1_20/transports/', testname, '/']; 
    ...
    fid = fopen(outfile,'w+');
    fprintf(fid,'%%korea  tsugaru   soya   taiwan kuro_intru  yellowsea west_ks east_ks jeju_n jeju_s \n');
    fclose(fid);
...
%     121.8  31.9 126.5  34.35];
    ...
    t_point=10;
    point_name={'korea','tsugaru','soya','taiwan','kuro_intrusion','yellowsea', 'west_ks', 'east_ks', 'jeju_n', 'jeju_s'};
    kts = [128.0 35.2 134.0 35.2 ...  
       140.5  42.0  140.54  41.0  ...
    142.0  47.0 142.04  45.0 ...
    118.65  24.6  120.2  23.75 ...
...
%     fprintf(fid,'%8.3f %8.3f %8.3f  \n', trans');
    fprintf(fid,'%8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f \n', trans');
    fclose(fid);
