...
% Updated 20-May-2022 by Yong-Yub Kim. calculation for ykang dir
% ====================================================================
...
% % addpath(genpath(['/scratch/snu01/kimyy/roms_nwp/nwp_1_10/output/',testname,'/TRANSP/m_map']))
% % addpath(genpath(['/scratch/snu01/kimyy/roms_nwp/nwp_1_10/output/',testname,'/TRANSP/netcdf_old']))

% fid=fopen('/scratch/snu01/kimyy/roms_nwp/nwp_1_10/output/modelinfo');
...
%     outputdir = inputdir; 
    ...
    for year = yearstart:yearend
        for month=1:12
    %     prefix = '/scratch/snu01/kimyy/roms_nwp/nwp_1_10/output/';
