...
clear all; close all;
addpath(genpath('/scratch/snu02/roms_nwp/output/test23/TRANSP/m_map'))
addpath(genpath('/scratch/snu02/roms_nwp/output/test23/TRANSP/netcdf_old'))
vert_param;

clc; tic;warning off
foot = '.nc';
outfile = ['roms_tr_test23_2.txt'];
...
for month=1:60
prefix = '/scratch/snu02/roms_nwp/output/test23/monthly_spinup_'
