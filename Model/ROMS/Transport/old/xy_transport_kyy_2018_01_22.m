...
outfile = ['roms_tr_test37_2018_01_22.txt'];

% fid = fopen(outfile,'w+');
% fprintf(fid,'%%korea tsugaru soya    taiwan  kuro_int yellow oya_coa oya_open \n');
% fclose(fid);
...
for year = 2012:2013
    ...
    ynumb = num2str(year,'%04i');
    mnumb = num2str(month,'%02i');
    %numb ='08';
    filename = strcat(prefix,testname,'/',ynumb,'/',testname,'_monthly_',ynumb,'_',mnumb,foot)
...
%     year_end   = yyyy;
    ...
    t_point= 8;  %test1
    point_name={'korea','tsugaru','soya','taiwan','kuro_intrusion','yellow', 'oya_coast', 'oya_open'};
    % point_name={'korea','tsugaru','soya','taiwan','kuro_intrusion','yellow'};
    ...
    kts = [128.0 35.2 134.0 35.2 ...  
        ...
        121.95  25.1  130.15  31.35 ... 
        121.8  31.9 126.5  34.35 ...
        143.5  42.5 146.8  38.0 ...
        157.5  51.0 160.8  46.5 ];
