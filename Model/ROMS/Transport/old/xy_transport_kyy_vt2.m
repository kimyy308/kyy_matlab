...
clear all; close all;
addpath(genpath('/scratch/snu02/roms_nwp/output/smooth13_vtvs/TRANSP/m_map'))
addpath(genpath('/scratch/snu02/roms_nwp/output/smooth13_vtvs/TRANSP/netcdf_old'))
vert_param;

clc; tic;warning off
foot = '.nc';
outfile = ['roms_tr_mon_sm13_vtvs_kyy_0007.txt'];
fid = fopen(outfile,'w+');
fprintf(fid,'%%korea  tsugaru   soya   taiwan kuro_intru yellowsea \n');
fclose(fid);

for month=85:96
prefix = '/scratch/snu02/roms_nwp/output/smooth13_vtvs/monthly_spinup_'
