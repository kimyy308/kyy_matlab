...
%     dropboxpath='/home01/kimyy/Dropbox'; %% ROMS server
    ...
    bry_prefix='/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_20/forcing_matlab/OBC/SODA_3_4_2/SODA_';
end
...
for Y = Ymin:Ymax
    ...
    for M = mo_min:mo_max
        ...
        for tndx_OGCM = 1:ntimes
            ...
            interp_OGCM_SODA3_climssh(OGCM_path, OGCM_prefix, Y, M, Roa, interp_method, ...
