function interp_OGCM_224(OGCM_dir,OGCM_prefix,year,month,Roa,interp_method,...
...
disp(['  Horizontal interpolation: ',...
      OGCM_prefix,num2str(year),num2char(month,2),'.cdf'])
%
%
% ROMS grid angle
%
...
% Open the OGCM file
%
name=[OGCM_dir,OGCM_prefix,num2str(year),num2char(month,2),'.cdf']
nc=netcdf(name);
%
