...
%
ROMS_title  = 'NorthPacific Model_ADD';
ROMS_config = 'NorthPacific_ADD';
%
%  ROMSTOOLS directory
%
ROMSTOOLS_dir = '../';
...
% grdname=['D:\add3_ini_bry_grd\grid\roms_grid3_ADD_08_2_ep.nc'];
grdname=['D:\add2_ini_bry_grd\grid\roms_grid2_ADD_08_2_ep.nc'];
frcname=['D:\Roms_tools\rivers\roms_river_add4_2_1993.nc'];
blkname=[ROMS_files_dir,'roms_blk.nc'];
clmname=[ROMS_files_dir,'roms_add4_clm.nc'];
...
% lonmax =  144;   % Maximum longitude [degree east]
...
lonmin =  115;   % Minimum longitude [degree east]
lonmax =  152;   % Maximum longitude [degree east]
latmin = 18;   % Minimum latitude  [degree north]
latmax = 52;   % Maximum latitude  [degree north]
%
