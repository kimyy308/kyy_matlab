...
for yind=1:length(year)
    ...
    elseif (linux==1)
        bryname = ['/data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/SODA_3_4_2/',testname, '/roms_bndy_',casename,'_SODA_3_4_2_',num2str(yyyy), '_',testname,'.nc'];
    end
...
%         cycle_length = 365.25;
    ...
    for mi = mm(1):mm(end);
        if (windows==1)
            filename = ['E:\Data\Model\ROMS\nwp_1_10\input\test38\','SODA_Y', num2str(yyyy,4), 'M', num2str(mi), '_',testname,'.nc'];
        elseif (linux==1)
            filename = ['/data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/SODA_3_4_2/',testname,'/SODA_CLIM_Y', num2str(yyyy,4), 'M', num2str(mi), '_',testname,'.nc'];
            system(['cd /data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/SODA_3_4_2/',testname])
            system(['ln -s ./SODA_CLIM_Y', num2str(yyyy,4), 'M1_', testname, '.nc' ...
                ' /data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/SODA_3_4_2/',testname,'/SODA_CLIM_Y', num2str(yyyy,4), 'M13_', testname, '.nc']);
            system(['ln -s ./SODA_CLIM_Y', num2str(yyyy,4), 'M12_', testname, '.nc' ...
                ' /data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/SODA_3_4_2/',testname,'/SODA_CLIM_Y', num2str(yyyy,4), 'M14_', testname, '.nc']);
        end
            nc = netcdf(filename);
