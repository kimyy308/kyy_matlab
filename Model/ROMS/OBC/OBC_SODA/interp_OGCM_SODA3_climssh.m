function interp_OGCM_SODA3_climssh(OGCM_dir,OGCM_prefix,year,month,Roa,interp_method,...
...
%
nc_ssh = netcdf([OGCM_dir,'globalsoda_ssh_trend_1980_2009.nc']);

zeta = ext_data_OGCM_SODA3(nc_ssh,lonT,latT,'clim_soda_ssh',tin,lon,lat,1,missvalue,Roa,interp_method);
%
