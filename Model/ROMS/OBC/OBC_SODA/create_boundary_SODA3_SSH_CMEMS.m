...
raw_testname = 'test15';
testname = 'test15';
OGCM_path = '/data2/kimyy/Observation/CMEMS/';
bry_prefix='/data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/SODA_3_4_2/test15/bndy_nwp_1_10_CMEMS_';
...
OGCM_prefix = 'NWP2cmems_ssh_trend_1993_2017';
...
for Y = Ymin:Ymax
    ...
    rawbryname = ['/data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/SODA_3_4_2/', testname, '/', ...
            'roms_bndy_nwp_1_10_SODA_3_4_2_',num2str(Y, '%04i'),'_',testname,'.nc'];
...
%         M_ind = (Y-1950)*12+M;
        ...
        for tndx_OGCM = 1:ntimes  %% ntimes = 1
            ...
            interp_OGCM_SODA3_SSH_CMEMS(OGCM_path, OGCM_prefix, Y, M, Roa, interp_method, ...
                lonU, latU, lonV, latV, lonT, latT, M, ...
                nc_clm, nc_bry, lon, lat, angle, h, M, obc)
        end
        %
