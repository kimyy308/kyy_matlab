...
disp(['  Horizontal interpolation: ',...
    'SODA3_CMEMS - ','Y',num2str(year),' - M',num2str(month),'.nc'])
%
%
% ROMS grid angle
%
...
if tin==13
    tin2=(year-1993)*12+1;
elseif tin==14
    tin2=(year-1993)*12+12;
else
    tin2=(year-1993)*12+tin;
end
zeta = ext_data_OGCM_SODA3(nc,lonT,latT,'cmems_sla',tin2,lon,lat,1,missvalue,Roa,interp_method);
...
% zeta= zeta + 0.0541; %% set mean sea level to zero. -0.0541 --> msl of 1993 Jan
