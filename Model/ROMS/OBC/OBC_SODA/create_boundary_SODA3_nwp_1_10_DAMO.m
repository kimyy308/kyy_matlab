...
%     dropboxpath='/home01/kimyy/Dropbox'; %% ROMS server
    ...
    addpath(genpath([dropboxpath '/source/matlab/Model/ROMS/Roms_tools/Preprocessing_tools']));
    OGCM_path = '/data2/kimyy/ext_hdd/Reanalysis/SODA/SODA_3_4_2/monthly/';
    bry_prefix='/data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/SODA_3_4_2/SODA_';
end
