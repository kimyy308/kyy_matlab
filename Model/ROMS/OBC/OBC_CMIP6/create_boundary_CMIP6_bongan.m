    ...
    %     OGCM_path=[tmp_OGCM_path];
        ...
        for M = mo_min:mo_max
            ...
            for tndx_OGCM = 1:ntimes
                ...
                switch scenario_name
                    case 'historical'
                         interp_OGCM_CMIP6(tmp_OGCM_path, OGCM_prefix, Y, M, interp_method, ...
                    lonU, latU, lonV, latV, lonT, latT, lonZ, latZ, Z, M, ...
                    nc_bry, lon, lat, angle, h, tndx_OGCM + itolap_a, obc,Vtransform,Vstretching,model_name,scenario_name, ensemble_name)
