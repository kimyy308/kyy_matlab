...
%     dropboxpath='/home01/kimyy/Dropbox'; %% ROMS server
    ...
    addpath(genpath([dropboxpath '/source/matlab/Model/ROMS/Roms_tools/Preprocessing_tools']));
    OGCM_path = '/data1/kimyy/Model/CMIP5/';
...
for Y = Ymin:Ymax
    ...
    for M = mo_min:mo_max
        ...
        nc = netcdf([OGCM_path, 'thetao_interp_ensemble_historical_r1i1p1_',num2str(Y,'%04i'), '.nc']);
        ...
        for tndx_OGCM = 1:ntimes
            ...
            interp_OGCM_CMIP5_ens13(OGCM_path, OGCM_prefix, Y, M, Roa, interp_method, ...
