function interp_OGCM_CMIP5_ens13(OGCM_dir,OGCM_prefix,year,month,Roa,interp_method,...
...
scenario_name='interp_ensemble_historical_r1i1p1';
nc_t = netcdf([OGCM_dir,'thetao_',scenario_name,'_',num2str(year,'%04i'),'.nc']);
nc_s = netcdf([OGCM_dir,'so_',scenario_name,'_',num2str(year,'%04i'),'.nc']);
nc_u = netcdf([OGCM_dir,'uo_',scenario_name,'_',num2str(year,'%04i'),'.nc']);
nc_v = netcdf([OGCM_dir,'vo_',scenario_name,'_',num2str(year,'%04i'),'.nc']);
nc_z = netcdf([OGCM_dir,'zos_',scenario_name,'_',num2str(year,'%04i'),'.nc']);
