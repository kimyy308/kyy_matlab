...
%     dropboxpath='/home01/kimyy/Dropbox'; %% ROMS server
    ...
    addpath(genpath([dropboxpath '/source/matlab/Model/ROMS/Roms_tools/Preprocessing_tools']));
    OGCM_path = '/data1/cshwa/tmp/history/forcing_total/';
...
grid_name = [OGCM_path, OGCM_prefix, '_ocean_thetao_', num2str(Ymin), '_v2.nc'];
nc = netcdf(grid_name);
...
%     OGCM_path=[tmp_OGCM_path,num2str(Y,'%04i'),'/'];
    ...
    for M = mo_min:mo_max
        ...
        nc = netcdf([OGCM_path, OGCM_prefix, '_ocean_thetao_',num2str(Y), '_v2.nc']);
        ...
        for tndx_OGCM = 1:ntimes
            ...
            interp_OGCM_CMIP5_total2(OGCM_path, OGCM_prefix, Y, M, Roa, interp_method, ...
