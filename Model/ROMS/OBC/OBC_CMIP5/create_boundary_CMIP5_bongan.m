...
switch scenario_name
    case 'historical'
        tmp_OGCM_path = '/home/auto/ext_hdd/CMIP5/';
    case 'rcp26'
...
tmp_bry_prefix='/home/kimyy/ext_hde/nwp_1_20/forcing_matlab/OBC/';
    ...
    %     OGCM_path=[tmp_OGCM_path];
        ...
        for M = mo_min:mo_max
            ...
            for tndx_OGCM = 1:ntimes
                ...
                switch scenario_name
                    case 'historical'
                         interp_OGCM_CMIP5_ens10(tmp_OGCM_path, OGCM_prefix, Y, M, interp_method, ...
                    ...
                    case 'rcp26'
                         interp_OGCM_CMIP5_rcp26_85(tmp_OGCM_path, OGCM_prefix, Y, M, interp_method, ...
                    lonU, latU, lonV, latV, lonT, latT, lonZ, latZ, Z, M, ...
                    nc_bry, lon, lat, angle, h, tndx_OGCM + itolap_a, obc,Vtransform,Vstretching,model_name,scenario_name)
