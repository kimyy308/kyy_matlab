...
%     dropboxpath='/home01/kimyy/Dropbox'; %% ROMS server
    ...
    addpath(genpath([dropboxpath '/source/matlab/Model/ROMS/Roms_tools/Preprocessing_tools']));
    OGCM_path = '/data1/kimyy/Observation/CMEMS/';
    bry_prefix=['/data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/', scenname,'/NorESM1-M/roms_bndy_nwp_1_10_NorESM1-M_CMEMSSSH_'];
end
...
OGCM_prefix = 'NWP2cmems_ssh_trend_1993_2018';
...
for Y = Ymin:Ymax
    ...
    rawbryname = ['/data1/kimyy/Model/ROMS/nwp_1_10/forcing_matlab/OBC/', scenname,'/NorESM1-M/', ...
            'roms_bndy_nwp_1_10_NorESM1-M_',num2str(Y, '%04i'),'_test16.nc'];
    ...
    for M = mo_min:mo_max
        ...
        for tndx_OGCM = 1:ntimes  %% ntimes = 1
            ...
            interp_OGCM_CMIP5_SSH_merged(OGCM_path, OGCM_prefix, Y, M, Roa, interp_method, ...
                lonU, latU, lonV, latV, lonT, latT, M_ind, ...
                nc_clm, nc_bry, lon, lat, angle, h, M_ind-(Y-1993)*12, obc)
        end
        %
