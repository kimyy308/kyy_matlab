...
for model_names_index=1:length(model_names)
    ...
    for yind=1:length(year)
        ...
        elseif (strcmp(system_name,'GLNXA64'))
            bryname = ['/home/kimyy/ext_hdd/nwp_1_20/forcing_matlab/OBC/',scenario_name,'/',model_name,'/roms_bndy_',casename,'_',model_name,'_',num2str(yyyy), '_',testname,'.nc'];
        end
        ...
        for mi = mm(1):mm(end);
            ...
            elseif (strcmp(system_name,'GLNXA64'))
                filename = ['/home/kimyy/ext_hdd/nwp_1_20/forcing_matlab/OBC/',scenario_name,'/',model_name,'/',model_name,'_Y', num2str(yyyy,4), 'M', num2str(mi), '_',testname,'.nc'];
            end
                nc = netcdf(filename);
