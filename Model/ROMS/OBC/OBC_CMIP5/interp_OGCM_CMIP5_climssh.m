function interp_OGCM_CMIP5_ens10(OGCM_dir,OGCM_prefix,year,month,interp_method,...
...
nc_ssh = netcdf(['/home/kimyy/SSH_project_source/data/','NorESM1-M_meanssh_1993_2019.nc']);

% % % nonsteric sealevel
% zeta = ext_data_OGCM_CMIP5_total(nc_ssh,lonZ,latZ,'clim_ssh',tin,lon,lat,1,missvalue,Roa,interp_method);
zeta = ext_data_OGCM_CMIP5_total(nc_ssh,lonZ,latZ,'clim_ssh',1,lon,lat,1,missvalue,Roa,interp_method);
