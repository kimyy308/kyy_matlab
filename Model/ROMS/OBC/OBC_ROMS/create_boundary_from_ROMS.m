clear; clc; close all
% % 
% % make lateral boundary file from ROMS model monthly output data (t,s,u,v,zeta)
% % Updated 14-Feb-2018 by Y.Y.Kim
...
if (strcmp(system_name,'PCWIN64'))
    ...
    OGCM_path = 'E:\Data\Model\ROMS\nwp_1_10\test06\DA\';
    bry_prefix= 'E:\Data\Model\ROMS\es_1_40\input';
...
%     dropboxpath='/home01/kimyy/Dropbox'; %% ROMS server
    ...
    addpath(genpath([dropboxpath '/source/matlab/Model/ROMS/Roms_tools/Preprocessing_tools']));
    OGCM_path = '/data1/cshwa/tmp/history/total/';
...
expname = 'es_1_40';
% % ROMS test name
model_name='nwp_1_10_test06';

bry_prefix=[bry_prefix,model_name,'/'];
if (exist(bry_prefix,'dir')~=7)
        mkdir(bry_prefix);
end
bry_prefix=[bry_prefix,model_name,'_'];  %% 'E:\Data\Model\ROMS\es_1_40\input\nwp_1_10_test06'
...
ROMS_title  = ['ROMS ', expname, ' OBC file from ', model_name];
ROMS_config = 'East Sea';
...
%     OGCM_path=[tmp_OGCM_path,num2str(Y,'%04i'),'/'];
    ...
    for M = mo_min:mo_max
        ...
        for tndx_OGCM = 1:ntimes
            ...
            interp_OGCM_CMIP5(OGCM_path, OGCM_prefix, Y, M, Roa, interp_method, ...
