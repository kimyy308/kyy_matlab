...
close all
clc;
%  Updated 16-Feb-2019 by Yong-Yub Kim
...
system(['mkdir E:\Data\Model\ROMS\nwp_1_20\input\test51\']);
disp(' ')
...
% shading interp;
h(inds:indn,indw:inde)=h(inds:indn,indw:inde)+20;

%% tsugaru strait

smootharea=[139.9, 141.5, 40.7, 41.9];
[indw, inde, inds, indn]=findind_Y(dl,smootharea,lon_rho,lat_rho);
h(inds:indn,indw:inde)=h(inds:indn,indw:inde)+5; 
