...
system(['copy ','E:\Data\Model\ROMS\nwp_1_20\input\roms_grid_nwp_1_20_with_dokdo.nc',' ',smoothname])
...
% shading interp;
h(inds:indn,indw:inde)=h(inds:indn,indw:inde)+15;
...
[indw, inde, inds, indn]=findind_Y(dl,smootharea,lon_rho,lat_rho);
h(inds:indn,indw:inde)=h(inds:indn,indw:inde)+5; % too much transport in the soya strait -> fixing depth
...
[indw, inde, inds, indn]=findind_Y(dl,smootharea,lon_rho,lat_rho);
rtarget = 0.5; n_filter_deep_topo = 5; n_filter_final = 5;  %% 1 hour blow up
h(inds:indn,indw:inde)=smoothgrid(h(inds:indn,indw:inde),maskr(inds:indn,indw:inde),hmin,hmax_coast,hmax, ...
  rtarget, n_filter_deep_topo, n_filter_final);
...
[indw, inde, inds, indn]=findind_Y(dl,smootharea,lon_rho,lat_rho);
rtarget = 0.8; n_filter_deep_topo = 5; n_filter_final = 2;
h(inds:indn,indw:inde)=smoothgrid(h(inds:indn,indw:inde),maskr(inds:indn,indw:inde),hmin,hmax_coast,hmax, ...
  rtarget, n_filter_deep_topo, n_filter_final);
...
smootharea=[129.3, 131.5, 36.5, 38];
[indw, inde, inds, indn]=findind_Y(dl,smootharea,lon_rho,lat_rho);
rtarget = 0.5;  n_filter_deep_topo = 5;  n_filter_final = 5;
h(inds:indn,indw:inde)=smoothgrid(h(inds:indn,indw:inde),maskr(inds:indn,indw:inde),hmin,hmax_coast,hmax, ...
  rtarget, n_filter_deep_topo, n_filter_final);

smootharea=[127.0, 129.5, 33.0, 41.5];
[indw, inde, inds, indn]=findind_Y(dl,smootharea,lon_rho,lat_rho);
rtarget = 0.7;  n_filter_deep_topo = 5;  n_filter_final = 5;
h(inds:indn,indw:inde)=smoothgrid(h(inds:indn,indw:inde),maskr(inds:indn,indw:inde),hmin,hmax_coast,hmax, ...
  rtarget, n_filter_deep_topo, n_filter_final);
...
smootharea=[115.0, 164.0, 15.0, 52.0];
[indw, inde, inds, indn]=findind_Y(dl,smootharea,lon_rho,lat_rho);
rtarget = 0.9; n_filter_deep_topo = 5; n_filter_final = 5;  %% 1 hour blow up
h(inds:indn,indw:inde)=smoothgrid(h(inds:indn,indw:inde),maskr(inds:indn,indw:inde),hmin,hmax_coast,hmax, ...
  rtarget, n_filter_deep_topo, n_filter_final);
...
figure;
lonlat = [127 135 35 43]; %% East Coast of Korea
m_proj('mercator','lon',[lonlat(1) lonlat(2)],'lat',[lonlat(3) lonlat(4)]);
m_grid('fontsize',20, 'box', 'fancy', 'tickdir', 'in');   %% for nwp = 25, for es = 20
hold on;
m_pcolor(lon_rho,lat_rho,h);
