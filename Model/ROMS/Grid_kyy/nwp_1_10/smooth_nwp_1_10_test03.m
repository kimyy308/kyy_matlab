...
romstools_param
warning off
rawname=['E:\Data\Model\ROMS\nwp_1_10\input\grid\roms_grid_nwp_1_10_not_smoothed.nc'];
system(['copy ',rawname,' ',smoothname])
...
[indw, inde, inds, indn]=findind_Y(smootharea,lon_rho,lat_rho);
...
smootharea=[129.0, 135.0, 35.2, 37.3];
[indw, inde, inds, indn]=findind_Y(smootharea,lon_rho,lat_rho);
...
smootharea=[130.3, 131.5, 37.0, 38.0];
[indw, inde, inds, indn]=findind_Y(smootharea,lon_rho,lat_rho);
rtarget = 0.2;  n_filter_deep_topo = 30;  n_filter_final = 5;
h(inds:indn,indw:inde)=smoothgrid(h(inds:indn,indw:inde),maskr(inds:indn,indw:inde),hmin,hmax_coast,hmax, ...
  rtarget, n_filter_deep_topo, n_filter_final);
