...
grdfile='/home/kimyy/Model/ROMS/nwp_1_10/input/test14/spinup/roms_grid_nwp_1_10_test14.nc';
...
for i=1:length(year)
    for k=1:length(CMIP5_names)
        for j=1:length(varname)
            ...
            testname = [CMIP5_name,'_nwp_1_10'];
            output_dir=['/data1/kimyy/Model/ROMS/nwp_1_10','/forcing_matlab/SBC/',scenario_name,'/',CMIP5_name,'/'];
