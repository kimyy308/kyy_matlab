function status=ROMS_surface_forcing_CMIP5_ens10(grdfile, year, varname, tinterval, outfiledir, testname, CMIP5_name, scenario_name)
% % This function is based on MATLAB 2017a
% % Updated 17-Feb-2019 by Y.Y.Kim
    
switch scenario_name
    case 'historical'
        root_dir = ['/data1/CMIP/cmip5/historical_extHDD/CMIP5/',varname,'/',scenario_name,'/interp/',CMIP5_name,'/'];
        tas_root_dir = ['/data1/CMIP/cmip5/historical_extHDD/CMIP5/','tas','/',scenario_name,'/interp/',CMIP5_name,'/'];
        psl_root_dir = ['/data1/CMIP/cmip5/historical_extHDD/CMIP5/','psl','/',scenario_name,'/interp/',CMIP5_name,'/'];
    case 'rcp45'
        root_dir = ['/data1/CMIP/cmip5/rcp_atm_extHDD/CMIP5/',varname,'/',scenario_name,'/interp/',CMIP5_name,'/'];
        tas_root_dir = ['/data1/CMIP/cmip5/rcp_atm_extHDD/CMIP5/','tas','/',scenario_name,'/interp/',CMIP5_name,'/'];
        psl_root_dir = ['/data1/CMIP/cmip5/rcp_atm_extHDD/CMIP5/','psl','/',scenario_name,'/interp/',CMIP5_name,'/'];
    otherwise
        root_dir = ['/data1/CMIP/cmip5/rcp_atm_extHDD/CMIP5/',varname,'/',scenario_name,'/interp/',CMIP5_name,'/'];
        tas_root_dir = ['/data1/CMIP/cmip5/rcp_atm_extHDD/CMIP5/','tas','/',scenario_name,'/interp/',CMIP5_name,'/'];
        psl_root_dir = ['/data1/CMIP/cmip5/rcp_atm_extHDD/CMIP5/','psl','/',scenario_name,'/interp/',CMIP5_name,'/'];
    ...
    tas_filename = strcat(tas_root_dir,'/','tas','_interp_',CMIP5_name,'_',scenario_name,'_r1i1p1_',num2str(year,'%04i'),'.nc');
    psl_filename = strcat(psl_root_dir,'/','psl','_interp_',CMIP5_name,'_',scenario_name,'_r1i1p1_',num2str(year,'%04i'),'.nc');
...
% % NorESM-M_zos_1976.nc
    ...
    switch varname
        ...
        case 'huss'
            varname_input = varname;
            varname_output = 'Qair';
            long_name = [CMIP5_name, ' Specific humidity'];
            units = ' '; 
        case 'psl'
            varname_input = varname;
            varname_output = 'Pair';
        ...
        case 'uas'
            varname_input = varname;
            varname_output = 'Uwind';
            long_name = [CMIP5_name, ' 10 Meter zonal wind velocity from uas'];
            units = 'm/s';
        case 'va'
            varname_input = varname;
        ...
        case 'vas'
            varname_input = varname;
            varname_output = 'Vwind';
            long_name = [CMIP5_name, ' 10 Meter meridional wind velocity from vas'];
            units = 'm/s';
        otherwise
            '?'
            return
...
%     lat_CMIP5 = ncread(atmfile,'lat', [lat_min(1)-1], [lat_max(1)-lat_min(1)+2]); 
    ...
    switch varname
        ...
        case 'huss'
            ...
            varname_output = 'Qair';
            long_name = [CMIP5_name, ' Relative humidity from huss'];
            units = 'Percentage';   
...
% %     end  
    ...
    netcdf.putAtt(ncid,netcdf.getConstant('NC_GLOBAL'), ...
        'source', [' CMIP5 ', CMIP5_name, ', ', scenario_name]);
    netcdf.putAtt(ncid,netcdf.getConstant('NC_GLOBAL'), ...
