...
for regionind=1:length(all_region)
    ...
    inputyear = [1982:2016]; % % put year which you want to plot [year year ...]
...
%             end
            len_lon = length(avhrr_lon(:));
                len_lat = length(avhrr_lat(:));
                avhrr_data = ncread(avhrrfilename,'temp',[avhrr_lon_min(1) avhrr_lat_min(1) 1], [avhrr_lon_max(1)-avhrr_lon_min(1) avhrr_lat_max(1)-avhrr_lat_min(1) 1]);
