...
%                         ref_data=ncread(ncname, 'mask_15day');
...
%             sum(ref_data(:), 'omitnan') %[2789 3078 2156 3188 3050 2806] -> [2174 2680 1764 2864 2422 2230]
...
%                 mean_later_data(mean_later_data==0)=NaN;
    sum(sum_later_data(:), 'omitnan')- sum(sum_ref_data(:), 'omitnan')

    mean_data=sum_later_data-sum_ref_data;
...
%                 txt{testnameind,3}=m_text(119, 48, test_text2{testnameind}, 'FontSize', m_grid_fontsize+4); 
    ...
    titlename = strcat('egg#, ',testname, ',(fut-his', ...
         ',',  ...
