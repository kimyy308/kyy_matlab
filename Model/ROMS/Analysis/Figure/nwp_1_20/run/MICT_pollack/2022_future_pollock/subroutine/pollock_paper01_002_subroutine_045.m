...
%                         egg_mask(egg_mask==0)=NaN;
            SK_EEZ_egg_mask=ncread(ncname, 'mask_30day').*SK_EEZ_mask;
            NK_EEZ_egg_mask=ncread(ncname, 'mask_30day').*NK_EEZ_mask;
            RU_PR_EEZ_egg_mask=ncread(ncname, 'mask_30day').*RU_PR_EEZ_mask;
            RU_SH_EEZ_egg_mask=ncread(ncname, 'mask_30day').*RU_SH_EEZ_mask;
            JP_EEZ_egg_mask=ncread(ncname, 'mask_30day').*JP_EEZ_mask;
...
%                 set(axRH,'ycolor','b', 'box', 'off', 'FontSize',15);
    ...
    title(['eggs (elapsed 30d)', ',', num2str(min(allyear),'%04i'),'-',num2str(max(allyear),'%04i'), ...
