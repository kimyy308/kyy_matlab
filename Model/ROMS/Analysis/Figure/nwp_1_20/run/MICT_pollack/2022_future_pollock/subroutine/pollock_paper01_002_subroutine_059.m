...
%                 mean_data = sum(comb_egg_mask,3)/size(comb_egg_mask,3);
        ...
        rawname='D:\Data\Model\ROMS\nwp_1_10\test06\DA\pollock_2\1983\0030d_19830201\output_0030d_19830201.nc';
        raw_par_lon = ncread(rawname, 'lon');
        raw_par_lat = ncread(rawname, 'lat');
...
%         set(ax{testnameind,2},'pos',pos_ax{testnameind});
        ...
        for pari=1:size(raw_par_lon,1)
            m_plot(raw_par_lon(pari,1),raw_par_lat(pari,1),'marker','o','color',[0.5,0,0], ...
              'markerfacecolor', [0.5,0,0], 'MarkerSize', 3, 'parent', ax{testnameind,1}); 
        end
