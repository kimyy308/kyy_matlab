...
% mean_later_data2=mean_later_data; mean_later_data2(mean_later_data2==0)=NaN;
% pcolor(mean_ref_data2'); shading flat; colorbar;
% pcolor(mean_later_data2'); shading flat; colorbar;
% pcolor(mean_data'); shading flat; colorbar; caxis([0.3 1]);
...
%                 txt{testnameind,3}=m_text(119, 48, test_text2{testnameind}, 'FontSize', m_grid_fontsize+4); 
    ...
    titlename = strcat('SSPR, ',testname, ',(fut-his', ...
         ',',  ...
    ...
    disp(' ')
    disp([fig_flags{6,1}, ' plot is created.'])
    disp(' ')
