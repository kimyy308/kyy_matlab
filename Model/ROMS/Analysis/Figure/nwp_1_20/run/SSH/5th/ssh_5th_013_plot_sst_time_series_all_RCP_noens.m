...
%     RCM_interped_sst_yearly_mean(testind,:)=mean(RCM_interped_sst_mean(testind,:,:),2,'omitnan');
...
%             set(mslplot,'LineWidth',2);
            set(gca,'FontSize',20);
            grid on
%             lgd=legend({'GCM-IPSL-LR','GCM-IPSL-MR', newline, 'GCM-Nor','GCM-MPI'});
            lgd=legend({'GCM-IPSL-LR'; 'GCM-IPSL-MR'; 'GCM-Nor'; 'GCM-MPI'}, 'NumColumns',2);
%             lgd=legend({strcat('GCM-IPSL-LR',string(newline), 'GCM-IPSL-MR'), 'GCM-Nor','GCM-MPI'});
