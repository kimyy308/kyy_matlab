...
gcm_testname  = {'IPSL-CM5A-LR', 'IPSL-CM5A-LR','IPSL-CM5A-LR','IPSL-CM5A-LR'};
rcm_testname  = {'test61', 'test61','test65','test65'};
gcm_period={[2006:2015], [2091:2100], [2006:2015], [2091:2100]};
rcm_period={[2006:2015], [2091:2100], [2006:2015], [2091:2100]};
gcm_scenname = {'rcp26', 'rcp26','rcp85','rcp85'};
...
for varind2=1:length(all_var2)
    ...
    for regionind2=1:length(all_region2)
            ...
            if (strcmp(system_name,'PCWIN64'))
                % % for windows
                figrawdir =strcat('Z:\내 드라이브\MEPL\project\SSH\5th_year\figure\all\presentation\'); % % where figure files will be saved
            ...
            tifname=strcat(figrawdir, 'SSH','.tif'); %% ~_year_month.jpg
