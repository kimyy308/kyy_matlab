...
% all_testname2 = {'test61', 'test62','test63','test64','test65', 'test66','test67','test68'};
all_testname2 = {'ens10'};
...
%                     '_ssh_analysis_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.nc'];
        ...
        matname = [filedir, testname, '_', regionname, '_', 'SSH', '_trend_sta_', num2str(min(inputyear),'%04i'), '-', num2str(max(inputyear),'%04i'), '.mat'];
