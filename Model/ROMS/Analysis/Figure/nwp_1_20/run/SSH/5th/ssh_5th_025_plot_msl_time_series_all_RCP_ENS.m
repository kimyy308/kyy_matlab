...
for folding=1:1
        jpgname=strcat(outfile, '_all_scen_ens_',regionname, '_RCM_msla_yearly_mean_', ...
...
README='regional model SSH, Time(xData2). xData2 should be used with datetick func';
savefilename='D:\Data\Model\ROMS\nwp_1_20\all\RCP_SSH_yearly_data.mat';
