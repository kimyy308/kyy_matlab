...
% start-------------------- decadal current plot
    pngname=strcat(outfile, '_ENSg_',regionname, '_clim_uv_',num2str(min(inputyear1),'%04i'), ...
...
%                 system(['magick ', pngname, ' -trim ', pngname]);
    enssavefilename = [dirs.enssavedir, 'ENSg_', regionname, '_', variable, '_mean_', num2str(min(inputyear1),'%04i'), '-', num2str(max(inputyear1),'%04i'),...
                    '_', num2str(min(RCM_info.months),'%04i'), '-', num2str(max(RCM_info.months),'%04i'), '.mat'];
...
% start-------------------- decadal SST, SSH, SSS plot
    for varind2=1:length(all_var2)
        ...
        pngname=strcat(outfile, '_ENSg_',regionname, '_clim_',variable, '_', num2str(min(inputyear1),'%04i'), ...
            '_',num2str(max(inputyear1),'%04i'),  ...
                    '_', num2str(min(RCM_info.months),'%04i'), '-', num2str(max(RCM_info.months),'%04i'),'.tif'); %% ~_year_month.jpg
        ...
        tmp.tifname=strcat(dirs.figdir, 'RCM_ENSg', '_clim_', variable, '_',num2str(min(RCM_info.years),'%04i'), ...
                     '_',num2str(max(RCM_info.years),'%04i'),  ...
                    '_', num2str(min(RCM_info.months),'%04i'), '-', num2str(max(RCM_info.months),'%04i'),'.tif'); %% ~_year_month.jpg
        run(param_script);
        for testnameind2=1:length(all_testname2)
