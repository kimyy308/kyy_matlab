...
RCM_info.subregions_korean = {'동해안', '서해안', '남해안'};
...
boxplot(RCM_fig.tot_trend_rand, RCM_fig.tot_trend_rand_name, 'BoxStyle', 'outline', 'Colors', 'b', 'ColorGroup', RCM_fig.tot_trend_rand_name, ...
    'Whisker', w95, 'symbol','')
ylim([2 12])
