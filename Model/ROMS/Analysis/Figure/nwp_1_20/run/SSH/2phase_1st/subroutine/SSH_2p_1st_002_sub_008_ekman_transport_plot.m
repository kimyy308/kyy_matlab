...
%                         D:\Data\Model\ROMS\nwp_1_20\backup_surf\test2102\run\v\1985\pck_test2102_v_monthly_1985_01.nc
    ...
    uvplot=m_quiver(cut_lon_rho(1:param.m_quiver_x_interval:end, 1:param.m_quiver_y_interval:end)', ...
                    ...
                    ekman_u_rho(1:param.m_quiver_x_interval:end, 1:param.m_quiver_y_interval:end)' * param.m_quiver_vector_size/5, ...
                    ekman_v_rho(1:param.m_quiver_x_interval:end, 1:param.m_quiver_y_interval:end)' * param.m_quiver_vector_size/5, ...
