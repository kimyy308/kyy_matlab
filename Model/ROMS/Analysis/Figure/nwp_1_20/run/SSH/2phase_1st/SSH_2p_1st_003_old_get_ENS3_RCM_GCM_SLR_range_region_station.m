...
% RCM_003_info.name={'test2102', 'test2103', 'test2104', 'test2105', 'test2106'};
...
GCM_003_info.name={'CNRM-ESM2-1', 'EC-Earth3-Veg', 'ACCESS-CM2'};
...
% %     set temporary variables (testname, regionname, filesep, ...)
        ...
        RCM_003_info.matname_mean_data_trend = [RCM_info.savedir,'ENS3','_',RCM_info.regionname, '_RCM_ssh_mean_data_trend_', ...
            num2str(min(RCM_info.years),'%04i'),'_',num2str(max(RCM_info.years),'%04i'),'.mat'];
        GCM_003_info.matname_mean_data_trend = [RCM_info.savedir,'ENS3','_',RCM_info.regionname, '_GCM_ssh_mean_data_trend_', ...
            num2str(min(RCM_info.years),'%04i'),'_',num2str(max(RCM_info.years),'%04i'),'.mat'];
