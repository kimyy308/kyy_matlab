...
for i = 1 : length(testnames)
    ...
    for year = syear : eyear
        ...
        for dayij = 1 : length(inputday)
            ...
            netcdf.defVarChunking(ncid, lon_rhovarid, 'CHUNKED', [RCM_grid.size_lon_rho/10, RCM_grid.size_lat_rho/10]);
            netcdf.defVarDeflate(ncid, lon_rhovarid, 1, 1, 1);
            ...
            netcdf.defVarChunking(ncid, lat_rhovarid, 'CHUNKED', [RCM_grid.size_lon_rho/10, RCM_grid.size_lat_rho/10]);
            netcdf.defVarDeflate(ncid, lat_rhovarid, 1, 1, 1);
            ...
            netcdf.defVarChunking(ncid, tempvarid, 'CHUNKED', [RCM_grid.size_lon_rho/10, RCM_grid.size_lat_rho/10 RCM_grid.size_depth/10 1]);
            netcdf.defVarDeflate(ncid, tempvarid, 1, 1, 1);
            ...
            netcdf.defVarChunking(ncid, saltvarid, 'CHUNKED', [RCM_grid.size_lon_rho/10, RCM_grid.size_lat_rho/10 RCM_grid.size_depth/10 1]);
            netcdf.defVarDeflate(ncid, saltvarid, 1, 1, 1);
            ...
            netcdf.defVarChunking(ncid, uvarid, 'CHUNKED', [RCM_grid.size_lon_rho/10, RCM_grid.size_lat_rho/10 RCM_grid.size_depth/10 1]);
            netcdf.defVarDeflate(ncid, uvarid, 1, 1, 1);
            ...
            netcdf.defVarChunking(ncid, vvarid, 'CHUNKED', [RCM_grid.size_lon_rho/10, RCM_grid.size_lat_rho/10 RCM_grid.size_depth/10 1]);
            netcdf.defVarDeflate(ncid, vvarid, 1, 1, 1);
            ...
            netcdf.defVarChunking(ncid, wvarid, 'CHUNKED', [RCM_grid.size_lon_rho/10, RCM_grid.size_lat_rho/10 RCM_grid.size_depth/10 1]);
            netcdf.defVarDeflate(ncid, wvarid, 1, 1, 1);
            ...
            netcdf.defVarChunking(ncid, zetavarid, 'CHUNKED', [RCM_grid.size_lon_rho/10, RCM_grid.size_lat_rho/10 1]);
            netcdf.defVarDeflate(ncid, zetavarid, 1, 1, 1);
            ...
            netcdf.defVarChunking(ncid,uwindvarid, 'CHUNKED', [RCM_grid.size_lon_rho/10, RCM_grid.size_lat_rho/10 1]);
            netcdf.defVarDeflate(ncid, uwindvarid, 1, 1, 1);
            ...
            netcdf.defVarChunking(ncid, vwindvarid, 'CHUNKED', [RCM_grid.size_lon_rho/10, RCM_grid.size_lat_rho/10 1]);
            netcdf.defVarDeflate(ncid, vwindvarid, 1, 1, 1);
