...
% % %         sea level analysis
fprintf('\n')
disp('subroutine SSH_2p_1st_001_sub_002_cal_SSH_trends') 
...
RCM_info.filename_trends = strcat(RCM_info.savedir, RCM_info.testname,'_',RCM_info.regionname, 'RCM_ssh_trend_', ...
...
if (exist(RCM_info.matname_trends , 'file') ~= 2 || flags.fig_tmp==2)   
...
%     trend_filtered = trend_filtered * 1000.0; %% m/y -> mm/y
    ...
    save(RCM_info.matname_trends, 'RCM_data_trend', '-v7.3');
