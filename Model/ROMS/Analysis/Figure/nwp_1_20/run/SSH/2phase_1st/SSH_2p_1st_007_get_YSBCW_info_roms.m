...
% %  Updated 17-Oct-2021 by Yong-Yub Kim for ROMS

% % % configuration of RCM
% RCM_info.name={'test2102', 'test2103', 'test2104', 'test2105', 'test2106'};
% RCM_info.name={'test57', 'test58', 'test59', 'test60'};
RCM_info.name={'test61', 'test62', 'test63', 'test64'};
...
% RCM_info.dataroot = ['/data1/RCM/CMIP5/rcp45_output_extHDD', filesep, 'Data', filesep, 'Model', filesep, ...
%     'ROMS', filesep, 'nwp_1_20', filesep];
RCM_info.dataroot = ['/data1/RCM/CMIP5/RCP_scenario_zip', filesep, ...
    'nwp_1_20', filesep, 'output', filesep, 'packed_monthly', filesep];
...
addpath(genpath(['/home/kimyy/Dropbox/source/matlab/function']));
...
%             case {'test65', 'test66', 'test67', 'test68'}
            ...
            case {'test61', 'test62', 'test63', 'test64'}
                 RCM_info.filename =[RCM_info.filedir, num2str(tmp.year,'%04i'), tmp.fs, ...
                    'pck_', RCM_info.testname, '_monthly_', num2str(tmp.year,'%04i'), '_', ...
                    num2str(tmp.month,'%02i'), '.nc'];
