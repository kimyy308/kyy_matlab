...
GCM_info.model = GCM_003_info.name;
...
% %     set temporary variables (testname, regionname, filesep, ...)
        RCM_info.testname = RCM_003_info.name{testnameind};
        ...
        RCM_003_info.matname_mean_data_trend = [RCM_info.savedir,'ENSg','_',RCM_info.regionname, '_RCM_ssh_mean_data_trend_', ...
            num2str(min(RCM_info.years),'%04i'),'_',num2str(max(RCM_info.years),'%04i'),'.mat'];
        GCM_003_info.matname_mean_data_trend = [RCM_info.savedir,'ENSg','_',RCM_info.regionname, '_GCM_ssh_mean_data_trend_', ...
            num2str(min(RCM_info.years),'%04i'),'_',num2str(max(RCM_info.years),'%04i'),'.mat'];
...
% % %             ex) RCM_mean_data.test2107.AKP4(i) = mean(RCM_data.yearly_mean(:)) 
        ...
        if testnameind==1
            ...
            RCM_mean_data.ens.(RCM_info.regionname)= ...
                RCM_mean_data.ens.(RCM_info.regionname) + RCM_mean_data.([RCM_info.testname]).(RCM_info.regionname)/length(RCM_003_info.name);
            ...
            GCM_mean_data.ens.(RCM_info.regionname)= ...
                GCM_mean_data.ens.(RCM_info.regionname) + GCM_mean_data.([RCM_info.testname]).(RCM_info.regionname)/length(RCM_003_info.name);
        else
            RCM_mean_data.ens.(RCM_info.regionname)= ...
                RCM_mean_data.ens.(RCM_info.regionname) + RCM_mean_data.([RCM_info.testname]).(RCM_info.regionname)/length(RCM_003_info.name);
            GCM_mean_data.ens.(RCM_info.regionname)= ...
        ...
        for i=1:length(RCM_info.subregions)
            ...
            if testnameind==1
                ...
                RCM_mean_data.ens.(tmp.subregion)= ...
                    RCM_mean_data.ens.(tmp.subregion) + RCM_mean_data.([RCM_info.testname]).(tmp.subregion)/length(RCM_003_info.name);
                ...
                GCM_mean_data.ens.(tmp.subregion)= ...
                    GCM_mean_data.ens.(tmp.subregion) + GCM_mean_data.([RCM_info.testname]).(tmp.subregion)/length(RCM_003_info.name);
            else
                RCM_mean_data.ens.(tmp.subregion)= ...
                    RCM_mean_data.ens.(tmp.subregion) + RCM_mean_data.([RCM_info.testname]).(tmp.subregion)/length(RCM_003_info.name);
                GCM_mean_data.ens.(tmp.subregion)= ...
...
% % %                 GCM
            ...
            if testnameind==1
                ...
                RCM_mean_data.ens.tidal_station(ind_sta,:)= ...
                    RCM_mean_data.ens.tidal_station(ind_sta,:) + RCM_mean_data.([RCM_info.testname]).tidal_station(ind_sta,:)/length(RCM_003_info.name);
                ...
                GCM_mean_data.ens.tidal_station(ind_sta,:)= ...
                    GCM_mean_data.ens.tidal_station(ind_sta,:) + GCM_mean_data.([RCM_info.testname]).tidal_station(ind_sta,:)/length(RCM_003_info.name);
            else
                RCM_mean_data.ens.tidal_station(ind_sta,:)= ...
                    RCM_mean_data.ens.tidal_station(ind_sta,:) + RCM_mean_data.([RCM_info.testname]).tidal_station(ind_sta,:)/length(RCM_003_info.name);
                GCM_mean_data.ens.tidal_station(ind_sta,:)= ...
...
% %     RCM_info.testname = RCM_003_info.name{i}
