...
% for snu_desktopd
% all_testname2 = {'test57', 'test58', 'test59'};
...
load(['E:\Data\Observation\NIFS\xls\NIFS_salt_trend_',num2str(2006,'%04i'),'_',num2str(2018,'%04i'),'.mat']);
...
%                 for numdepth=1:size(NIFS6.line,5)
                    ...
                    if (isnan(NIFS6.lon(1,numline,numsta,monthij,1))==1)
...
%                         squeeze(NIFS6.lat(yearij,numline,numsta,monthij,numdepth)));
                        ...
                        lon_sta_diff = abs(lon - NIFS6.lon(1,numline,numsta,monthij,1));
                        min_lon_sta_diff=min(min(lon_sta_diff));
                        lon_sta_min = find(lon_sta_diff == min_lon_sta_diff,1);
                        
                        lat_sta_diff = abs(lat(lon_sta_min,:) - NIFS6.lat(1,numline,numsta,monthij,1));
