...
% % % % % %             
% % % % % %           % % % %             % msl pcolor (anomaly)  
% % % % % %         jpgname=strcat(outfile2, '_', testname,'_',regionname, '_msl_ano_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'), '.tif'); %% ~_year_month.jpg 
% % % % % %         if (exist(jpgname , 'file') ~= 2)
% % % % % %             m_proj(m_proj_name,'lon',[lonlat(1)-0.5 lonlat(2)+0.5],'lat',[lonlat(3)-0.5 lonlat(4)+0.5]);
% % % % % %             hold on;
% % % % % %             msl_alltime=squeeze(mean(comb_yearly_interped_data,3,'omitnan'))'.*1000;
% % % % % %             msl_alltime=msl_alltime-mean(mean(msl_alltime,1,'omitnan'),2,'omitnan');
% % % % % %             m_pcolor(double(recon_lon),recon_lat',msl_alltime);
% % % % % %     %         m_pcolor(double(recon_lon),recon_lat',squeeze(recon_trend_filtered(:,:)'));
% % % % % %             shading(gca,m_pcolor_shading_method);
% % % % % %             m_gshhs_i('color',m_gshhs_line_color);
% % % % % %             m_gshhs_i('patch',m_gshhs_land_color);   % gray colored land
...
% % % % % %         end  
% % % % % %         
% % % % % %         jpgname=strcat(outfile2, '_', testname,'_',regionname, '_msl_abs_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'), '.tif'); %% ~_year_month.jpg
% % % % % %         if (exist(jpgname , 'file') ~= 2)        
...
% % % % % %             
% % % % % %             
% % % % % %             jpgname=strcat(outfile2, '_', testname,'_',regionname, '_msl_abs_',num2str(tempyear,'%04i'), '.tif'); %% ~_year_month.jpg
% % % % % %             if (exist(jpgname , 'file') ~= 2)               
% % % % % %                 m_proj(m_proj_name,'lon',[lonlat(1)-0.5 lonlat(2)+0.5],'lat',[lonlat(3)-0.5 lonlat(4)+0.5]);
% % % % % %                 hold on;
% % % % % %                 msl_alltime=squeeze(comb_yearly_interped_data(:,:,yearij))'.*1000;
% % % % % %                 m_msl=mean(mean(msl_alltime,1,'omitnan'),2,'omitnan');
% % % % % %                 m_pcolor(double(recon_lon),recon_lat',msl_alltime);
% % % % % %         %         m_pcolor(double(recon_lon),recon_lat',squeeze(recon_trend_filtered(:,:)'));
% % % % % %                 shading(gca,m_pcolor_shading_method);
...
% % % % % %                 jpgname=strcat(outfile2, '_', testname,'_',regionname, '_msl_diff_',num2str(inputyear(yearij+1),'%04i'),'_',num2str(tempyear,'%04i'), '.tif'); %% ~_year_month.jpg
% % % % % %                 if (exist(jpgname , 'file') ~= 2)
% % % % % %                      % % % %             % msl pcolor (diff)
% % % % % %                     m_proj(m_proj_name,'lon',[lonlat(1)-0.5 lonlat(2)+0.5],'lat',[lonlat(3)-0.5 lonlat(4)+0.5]);
% % % % % %                     hold on;
% % % % % %                     msl_diff=squeeze(comb_yearly_interped_data(:,:,yearij+1))'.*1000 - squeeze(comb_yearly_interped_data(:,:,yearij))'.*1000;
% % % % % %                     m_msl=mean(mean(msl_diff,1,'omitnan'),2,'omitnan');
% % % % % %                     m_pcolor(double(recon_lon),recon_lat',msl_diff);
% % % % % %                     shading(gca,m_pcolor_shading_method);
% % % % % %                     m_gshhs_i('color',m_gshhs_line_color);
% % % % % %                     m_gshhs_i('patch',m_gshhs_land_color);   % gray colored land
...
% % % % % %                 jpgname=strcat(outfile3, '_', testname,'_',regionname, '_msl_abs_',num2str(tempyear,'%04i'),num2str(tempmonth,'%02i'), '.tif'); %% ~_year_month.jpg
% % % % % %                 if (exist(jpgname , 'file') ~= 2)
% % % % % %                     m_proj(m_proj_name,'lon',[lonlat(1)-0.5 lonlat(2)+0.5],'lat',[lonlat(3)-0.5 lonlat(4)+0.5]);
% % % % % %                     hold on;
% % % % % %                     msl_alltime=squeeze(comb_monthly_interped_data(:,:,monthij,yearij))'.*1000;
% % % % % %                     m_msl=mean(mean(msl_alltime,1,'omitnan'),2,'omitnan');
% % % % % %                     m_pcolor(double(recon_lon),recon_lat',msl_alltime);
% % % % % %             %         m_pcolor(double(recon_lon),recon_lat',squeeze(recon_trend_filtered(:,:)'));
% % % % % %                     shading(gca,m_pcolor_shading_method);
...
% % % % % %         
% % % % % %         
% % % % % %         jpgname=strcat(outfile2, '_', testname, '_',regionname, '_msl_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'), '.jpg'); %% ~_year_month.jpg
% % % % % %         if (exist(jpgname , 'file') ~= 2)
...
% % % % % %         end
% % % % % %         
% % % % % %         jpgname=strcat(outfile2, '_', testname, '_',regionname, '_msl_nonfilt_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'), '.jpg'); %% ~_year_month.jpg
% % % % % %         if (exist(jpgname , 'file') ~= 2)
...
% % % % % %         
% % % % % %         
% % % % % %         jpgname=strcat(outfile2, '_', testname, '_',regionname,'_recon_msl_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'), '.jpg'); %% ~_year_month.jpg
% % % % % %         if (exist(jpgname , 'file') ~= 2)
...
% % % % % %         yearly_interped_trend = yearly_interped_trend * 1000.0; %% m/y -> mm/y
% % % % % %         
% % % % % %         jpgname=strcat(outfile2, '_', testname, '_',regionname, '_yearly_msl_',num2str(min(inputyear),'%04i'),'-',num2str(max(inputyear),'%04i'), '.jpg'); %% ~_year_month.jpg
% % % % % % 
% % % % % %         if (exist(jpgname , 'file') ~= 2)
...
% % % % % %         end
% % % % % %         
% % % % % %         jpgname=strcat(outfile2, '_', testname, '_',regionname, '_yearly_corrected_msl_',num2str(min(inputyear),'%04i'),'-',num2str(max(inputyear),'%04i'), '.jpg'); %% ~_year_month.jpg
% % % % % %         if (exist(jpgname , 'file') ~= 2)
...
% % % % % %         
% % % % % %         jpgname=strcat(outfile2, '_', testname, '_',regionname,'_yearly_recon_msl_',num2str(min(inputyear),'%04i'),'-',num2str(max(inputyear),'%04i'), '.jpg'); %% ~_year_month.jpg
% % % % % % 
% % % % % %         if (exist(jpgname , 'file') ~= 2)
