...
%                 recon_data_ind=(tempyear-1950)*12+tempmonth-1;
                recon_data_ind=(1976-1950)*12+tempmonth-1;
        ...
        save([filedir,testname,'_',regionname,'ssh_recon_trend_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'], '-v7.3', '-nocompression');
