...
RCM_testnames = {'test2127', 'test2128', 'test2129', 'test2130', 'test2131'};
...
inputyear = [2015:2100]; % % put year which you want to plot [year year ...]
...
for testind=1:length(RCM_testnames)
    ...
    elseif (strcmp(scenname,'rcp85')==1)
        drivename='D';
    elseif (strcmp(scenname,'historical')==1 || strcmp(scenname,'ssp585')==1)
        drivename='D';
    end
...
if (strcmp(system_name,'PCWIN64'))
    % % for windows
    figrawdir =strcat('D:\MEPL\project\SSH\7th_year\figure\all\',regionname,'\'); % % where figure files will be saved
...
%             set(mslplot,'LineWidth',2);
            set(gca,'FontSize',20);
            grid on
            lgd=legend({'GCM-CNRM'; 'GCM-ECV'; 'GCM-ACC'; 'GCM-CNH'; 'GCM-CMC'; 'CMEMS'}, 'NumColumns',2);
