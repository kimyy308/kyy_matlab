...
%           load(['J:\Data\Model\CMIP5\zos\rcp45\interp\',testname,'\',testname,'_',regionname, ...
%                     'ssh_trend_rcp45_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat']);

%           filename = ['E:\Data\Model\CMIP5\zos\rcp45\interp\',testname,'\',testname,'_',regionname, ...
%                     '_ssh_analysis_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.nc'];
                
         filename = ['E:\Data\Model\CMIP5\zos\rcp45\interp\',testname,'\',testname,'_',regionname, ...
                    'cmems_interped_ssh_trend_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.nc'];
        trend_filt=ncread(filename, 'interped_trend_filtered');
