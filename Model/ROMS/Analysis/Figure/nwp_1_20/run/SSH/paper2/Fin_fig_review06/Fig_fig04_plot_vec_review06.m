...
%             figrawdir =strcat('C:\Users\User\Desktop\'); % % where figure files will be saved
            figrawdir =strcat('D:\MEPL\project\SSH\5th_year\figure\paper2\fin_fig_r6\'); % % where figure files will be saved
        ...
        hold on;
        tifname=strcat(figrawdir, 'fig04','.tif'); %% ~_year_month.jpg
...
%      ---------- GCM-IPSL-L
        ...
        for testnameind=1:4
            ...
            load([cmip5dir,regionname, '_', testname, '_cmip5_land_vec','.mat']);
...
%                 end
            ...
            elseif (testnameind==3)
                u_rho(ref_vec_x_range+1,ref_vec_y_range)=NaN;
                v_rho(ref_vec_x_range+1,ref_vec_y_range)=NaN;
...
%         saveas(gcf,tifname,'tif');
        ...
        save ('D:\research\Ph_D_course\2020_SSH_CMIP5_decadal_variation_around_korea_using_downscaling_ocean_model\data_dryad\Data04_SVel.mat', ...
