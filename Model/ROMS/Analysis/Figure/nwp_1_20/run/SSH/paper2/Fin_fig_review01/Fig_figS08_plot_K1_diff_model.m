...
for regionind2=1:length(all_region2)
        ...
        tifname=strcat(figrawdir, 'figS08','.tif'); %% ~_year_month.jpg
...
%      ---------- RCP 4.5
        for testnameind=1:4
            ...
            diffname=[tidedir, testname, '_diff_k1_', num2str(max(inputyear),'%04i'), '-', num2str(min(inputyear),'%04i'), '.mat'];
            clear k1_amp_diff
            load(diffname)
            
            mean_data=k1_amp_diff;
...
%         saveas(gcf,tifname,'tif');
        ...
        save (['Z:\내 드라이브\research\Ph_D_course\2020_SSH_CMIP5_decadal_variation_around_korea_using_downscaling_ocean_model', ...
            '\data_dryad\DataS08_Tidal_amp_changes_K1.mat'], ...
