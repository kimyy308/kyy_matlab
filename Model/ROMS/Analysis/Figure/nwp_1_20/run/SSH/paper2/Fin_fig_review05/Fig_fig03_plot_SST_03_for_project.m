...
%             figrawdir =strcat('Z:\내 드라이브\MEPL\project\SSH\5th_year\figure\paper2\fin_fig\'); % % where figure files will be saved
            figrawdir =strcat('D:\MEPL\project\climate_modeling\2022\proposal\figure\'); % % where figure files will be saved            
        ...
        hold on;
        tifname=strcat(figrawdir, 'fig03_02','.tif'); %% ~_year_month.jpg
...
%      ---------- AVHRR
        ...
        avhrrdir='D:\Data\Observation\OISST\monthly\';
...
%         shading(gca,m_pcolor_shading_method); 
        ...
        m_grid('fontsize', m_grid_fontsize, 'tickdir', m_grid_tickdir_type,  ...
                'xticklabels', [], 'xtick',[120,  130, 140], 'xaxislocation', 'top', ...
                'yticklabels', [32, 36, 40, 44, 48], 'ytick',[32, 36, 40, 44, 48], 'backcolor', 'none', 'parent', ax1_2);  
%         txt_1_2=m_text(118, 49, '(A) OISST', 'FontSize', m_grid_fontsize+4); 
