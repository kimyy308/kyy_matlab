...
%             matname2 = ['G:\Data\Model\ROMS\nwp_1_20\', 'IPSL-CM5A-LR', '\run\','IPSL-CM5A-LR','_',regionname,'model_cmems_ssh_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'];
%             matname3 = ['G:\Data\Model\ROMS\nwp_1_20\', 'IPSL-CM5A-MR', '\run\','IPSL-CM5A-MR','_',regionname,'model_cmems_ssh_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'];
%             matname4 = ['G:\Data\Model\ROMS\nwp_1_20\', 'NorESM1-M', '\run\','NorESM1-M','_',regionname,'model_cmems_ssh_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'];
%             matname5 = ['G:\Data\Model\ROMS\nwp_1_20\', 'MPI-ESM-LR', '\run\','MPI-ESM-LR','_',regionname,'model_cmems_ssh_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'];
            
            matname2 = ['G:\Data\Model\ROMS\nwp_1_20\', 'test57', '\run\','test57','_',regionname,'model_cmems_ssh_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'];
            matname3 = ['G:\Data\Model\ROMS\nwp_1_20\', 'test58', '\run\','test58','_',regionname,'model_cmems_ssh_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'];
            matname4 = ['G:\Data\Model\ROMS\nwp_1_20\', 'test59', '\run\','test59','_',regionname,'model_cmems_ssh_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'];
            matname5 = ['G:\Data\Model\ROMS\nwp_1_20\', 'test60', '\run\','test60','_',regionname,'model_cmems_ssh_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'];
...
%                 end
                load(matname2)
                temp_comb_spatial_meanmodel(1,:,:,:)=comb_spatial_meanmodel;
                temp_comb_data(1,:,:,:)=comb_data;
                temp_comb_spatial_meaninterped(1,:,:,:)=comb_spatial_meaninterped;
                temp_comb_interped_data(1,:,:,:)=comb_interped_data;
                
                load(matname3)
                temp_comb_spatial_meanmodel(2,:,:,:)=comb_spatial_meanmodel;
                temp_comb_data(2,:,:,:)=comb_data;
                temp_comb_spatial_meaninterped(2,:,:,:)=comb_spatial_meaninterped;
                temp_comb_interped_data(2,:,:,:)=comb_interped_data;
                
                load(matname4)
                temp_comb_spatial_meanmodel(3,:,:,:)=comb_spatial_meanmodel;
                temp_comb_data(3,:,:,:)=comb_data;
                temp_comb_spatial_meaninterped(3,:,:,:)=comb_spatial_meaninterped;
                temp_comb_interped_data(3,:,:,:)=comb_interped_data;
                
                load(matname5)
                temp_comb_spatial_meanmodel(4,:,:,:)=comb_spatial_meanmodel;
                temp_comb_data(4,:,:,:)=comb_data;
                temp_comb_spatial_meaninterped(4,:,:,:)=comb_spatial_meaninterped;
                temp_comb_interped_data(4,:,:,:)=comb_interped_data;
                
                comb_spatial_meanmodel=squeeze(mean(temp_comb_spatial_meanmodel,1));
                comb_data=squeeze(mean(temp_comb_data,1));
                comb_spatial_meaninterped=squeeze(mean(temp_comb_spatial_meaninterped,1));
                comb_interped_data=squeeze(mean(temp_comb_interped_data,1));
...
% % %     interped sea level trend analysis
        ...
        while (fig_flag)
            ncoutfilename = strcat(filedir, testname,'_',regionname, 'cmems_interped_ssh_trend_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'), '.nc');
            if (exist(ncoutfilename , 'file') ~= 2 || fig_flag==2)   
...
% %                end
            ...
            % % %         make ncfile
                ...
                clim_interped_ssh_trendvarid=netcdf.defVar(ncid, 'clim_interped_ssh_trend', 'NC_FLOAT', [lon_dimid lat_dimid clim_time_dimid]);
...
% %                 netcdf.putVar(ncid, corrected_interped_slavarid, [0 0 0], [len_lon_cmems len_lat_cmems length(ftime)], corrected_interped_sla);
                ...
                netcdf.putVar(ncid, clim_interped_trendvarid, [0 0 0], [len_lon_cmems len_lat_cmems 12], interped_trend_clim);
