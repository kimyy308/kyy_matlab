...
for regionind2=1:length(all_region2)
        ...
        tifname=strcat(figrawdir, 'figS04','.tif'); %% ~_year_month.jpg
...
%             mask_model(mask_model==0)=NaN;
            ...
            mean_data = all_mano_slc(:,:,testnameind);
            ...
            ysecs_mano_slc=all_mano_slc(:,:,testnameind).*ysecsmask;
            es_mano_slc=all_mano_slc(:,:,testnameind).*esmask;
            [mean_ysecs_mano_slc(testnameind,1), error_status] = Func_0011_get_area_weighted_mean(ysecs_mano_slc, lon_glo, lat_glo);
            [mean_es_mano_slc(testnameind,1), error_status] = Func_0011_get_area_weighted_mean(es_mano_slc, lon_glo, lat_glo);
...
%             mean_data= mean_data .* mask_model;        
           ...
           GCM_manometric_SLR{testnameind}=mean_data;
        end
%      ---------- GCM
...
%                         'labelspacing', 50000,'Rotation', 0,'fontweight', 'bold');
            ...
            RCM_manometric_SLR{testnameind-5}=mean_data;
        end
...
%         testnameind=5;
            ...
            mean_data = all_mano_slc(:,:,testnameind-5) - all_mano_slc(:,:,testnameind-10);
...
%             pos_sb{testnameind} = pos_sb{testnameind} + correction_large_fig;
            ...
            DIFF_manometric_SLR{testnameind-10}=mean_data;
        end
...
%         saveas(gcf,tifname,'tif');
        ...
        hold off;
        close all;
        save ('Z:\내 드라이브\research\Ph_D_course\2020_SSH_CMIP5_decadal_variation_around_korea_using_downscaling_ocean_model\data_dryad\DataS04_manometric_SLR_rcp85.mat', ...
            'GCM_lon', 'GCM_lat', 'GCM_manometric_SLR', ...
            'RCM_lon', 'RCM_lat', 'RCM_manometric_SLR', ...
            'DIFF_lon', 'DIFF_lat', 'DIFF_manometric_SLR', ...
