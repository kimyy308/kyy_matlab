...
scenname='rcp45';
GCM_testnames2 = {'GCM-IPSL-L', 'GCM-IPSL-M', 'GCM-Nor', 'GCM-MPI'};
RCM_testnames2 = {'RCM-IPSL-L', 'RCM-IPSL-M', 'RCM-Nor', 'RCM-MPI'};
all_region2 ={'AKP4'};
...
%         set(lgd,'Orientation','horizontal');  
        ...
        GCM_time=xData2;
        GCM_MSL.rcp45=GCM_interped_sla_yearly_mean;
...
%         set(lgd,'Orientation','horizontal');  
        ...
        RCM_time=xData2;
        RCM_MSL.rcp45=RCM_interped_sla_yearly_mean;
...
%         set(lgd,'Orientation','horizontal');  
        ...
        GCM_time=xData2;
        GCM_MSL.rcp85=GCM_interped_sla_yearly_mean;
...
%         set(lgd,'Orientation','horizontal');  
        ...
        RCM_time=xData2;
        RCM_MSL.rcp85=RCM_interped_sla_yearly_mean;
...
%         saveas(gcf,tifname,'tif');
        ...
        hold off;
        close all;
        save ('Z:\내 드라이브\research\Ph_D_course\2020_SSH_CMIP5_decadal_variation_around_korea_using_downscaling_ocean_model\data_dryad\Data08_MSL.mat', ...
            'GCM_time', 'GCM_MSL', ...
            'RCM_time', 'RCM_MSL', ...
            'GCM_testnames2', 'RCM_testnames2')
end