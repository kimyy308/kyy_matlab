...
for regionind2=1:length(all_region2)
        ...
        tifname=strcat(figrawdir, 'figS01','.tif'); %% ~_year_month.jpg
...
%             mask_model(mask_model==0)=NaN;
            ...
            mean_data = all_steric_slc(:,:,testnameind);
            ...
            ysecs_steric_slc=all_steric_slc(:,:,testnameind).*ysecsmask;
            es_steric_slc=all_steric_slc(:,:,testnameind).*esmask;
            [mean_ysecs_steric_slc(testnameind,1), error_status] = Func_0011_get_area_weighted_mean(ysecs_steric_slc, lon_glo, lat_glo);
            [mean_es_steric_slc(testnameind,1), error_status] = Func_0011_get_area_weighted_mean(es_steric_slc, lon_glo, lat_glo);
...
%         testnameind=5;
            ...
            mean_data = all_steric_slc(:,:,testnameind-5) - all_steric_slc(:,:,testnameind-10);
