...
%             figrawdir =strcat('Z:\내 드라이브\MEPL\project\SSH\5th_year\figure\paper2\fin_fig_r1\'); % % where figure files will be saved
        ...
        hold on;
        tifname=strcat(figrawdir, 'fig05_03','.tif'); %% ~_year_month.jpg
...
%         testnameind=5;
            ...
            RCM_SSH{testnameind-4}=mean_data;
            if testnameind==8
                m_grid('fontsize', m_grid_fontsize, 'tickdir', m_grid_tickdir_type,  ...
                    'xticklabels', [120,  130, 140], 'xtick',[120,  130, 140], ...
...
%                  caxis(ax1_1,sl_caxis);
%             else
%                 h{colbarind} = colorbar(ax1_2);
%                 caxis(ax1_2,sl_caxis);
%             end
%         
...
%         saveas(gcf,tifname,'tif');
        ...
        hold off;
        close all;
        save ('D:\research\Ph_D_course\2020_SSH_CMIP5_decadal_variation_around_korea_using_downscaling_ocean_model\data_dryad\Data05_SSH.mat', ...
            'CMEMS_lon', 'CMEMS_lat', 'CMEMS_SSH', ...
            'GCM_lon', 'GCM_lat', 'GCM_SSH', ...
            'RCM_lon', 'RCM_lat', 'RCM_SSH', ...
