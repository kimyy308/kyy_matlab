...
for regionind2=1:length(all_region2)
        close all;
        sl_caxis= ([-0.2 0.6]);
        inputyear1 = [1986]; % % put year which you want to plot [year year ...]
        inputyear2 = [1995]; % % put year which you want to plot [year year ...]
        inputyear3 = [2005]; % % put year which you want to plot [year year ...]
        ...
        tifname=strcat(figrawdir, 'R2Q5C8_hist','.tif'); %% ~_year_month.jpg
