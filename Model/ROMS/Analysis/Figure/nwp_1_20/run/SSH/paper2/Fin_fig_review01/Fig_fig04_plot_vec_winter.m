...
for regionind2=1:length(all_region2)
        ...
        hold on;
        tifname=strcat(figrawdir, 'fig04_winter','.tif'); %% ~_year_month.jpg
...
%         load(['D:\Data\Model\ROMS\nwp_1_20\',testname,'\run\',regionname,'sst_rms_and_bias_',num2str(inputyear(1),'%04i'),'_',num2str(inputyear(end)),'.mat']);
        ...
        winter_cmems_u=reshap_cmems_u(:,:,inputmonth2,:);
        winter_cmems_v=reshap_cmems_v(:,:,inputmonth2,:);
        winter_cmems_u2=winter_cmems_u(:,:,:);
        winter_cmems_v2=winter_cmems_v(:,:,:);
        winter_mean_u=mean(winter_cmems_u2,3);
        winter_mean_v=mean(winter_cmems_v2,3);
...
%         mean_data= mean_data .* mask_model;    
        ...
        quiv1_2=m_quiver(cut_lon_rho(1:m_quiver_x_interval:end,1:m_quiver_y_interval:end)', ...
                        ...
                        winter_mean_u(1:m_quiver_x_interval:end,1:m_quiver_y_interval:end)' * m_quiver_vector_size, ...
                        winter_mean_v(1:m_quiver_x_interval:end,1:m_quiver_y_interval:end)' * m_quiver_vector_size, ...
...
%             end
            ...
            load([cmip5dir,regionname,'_',testname, '_cmip5_', variable,'_winter_',yearstr_min, '_', yearstr_max, '.mat']);
...
%         testnameind=5;
            ...
            load([filedir,regionname,'_',testname, '_model_winter_', variable,'_',yearstr_min, '_', yearstr_max, '.mat']);
            mask_model = double(inpolygon(cut_lon_rho,cut_lat_rho,refpolygon(:,1),refpolygon(:,2)));
            mask_model(mask_model==0)=NaN;
