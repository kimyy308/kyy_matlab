...
fid=fopen('/scratch/snu01/kimyy/roms_nwp/nwp_1_20/output/modelinfo_fig_only');
...
for i=1:length(year)   
    ...
    status=plot_ROMS_monthly_horizontal_t_uv(testname, suvfile, outputdir, [127 144 33 52 -100 -100], tempyear, month, ...
                                    [0 30], [1 2 3 5 10 15 20 30], 'temp', 'fig_param_kyy_EJS_deep');
    ...
    status=plot_ROMS_monthly_horizontal_t_uv(testname, suvfile, outputdir, [127 144 33 52 -200 -200], tempyear, month, ...
                                    [0 20], [1 2 3 5 10 15 20], 'temp', 'fig_param_kyy_EJS_deep');
    ...
    status=plot_ROMS_monthly_horizontal_t_uv(testname, suvfile, outputdir, [127 144 33 52 -400 -400], tempyear, month, ...
                                    [0 10], [1 2 3 5 10], 'temp', 'fig_param_kyy_EJS_deep');
    ...
    status=plot_ROMS_monthly_horizontal_t_uv(testname, suvfile, outputdir, [127 144 33 52 -700 -700], tempyear, month, ...
                                    [0 3], [0:0.3:3], 'temp', 'fig_param_kyy_EJS_deep');
    
    if (exist(strcat(figdir,'EJS/','TUV_1300m') , 'dir') ~= 7)
        mkdir(strcat(figdir,'EJS/','TUV_1300m'));
    end
    suvfile =[figdir, 'EJS/', 'TUV_1300m/', 'EJS_1300m_TUV']; % % ~/SUV_EJS_testname_year_month.jpg
    status=plot_ROMS_monthly_horizontal_t_uv(testname, suvfile, outputdir, [127 144 33 52 -1300 -1300], tempyear, month, ...
                                    [0 3], [0:0.3:3], 'temp', 'fig_param_kyy_EJS_deep');
    ...
    status=plot_ROMS_monthly_horizontal_t_uv(testname, suvfile, outputdir, [127 144 33 52 -2000 -2000], tempyear, month, ...
                                    [0 3], 0:0.2:2, 'temp', 'fig_param_kyy_EJS_deep');
    ...
    status=plot_ROMS_monthly_horizontal_t_uv(testname, suvfile, outputdir, [127 144 33 52 -3000 -3000], tempyear, month, ...
                                    [0 3], 0:0.2:2, 'temp', 'fig_param_kyy_EJS_deep');
