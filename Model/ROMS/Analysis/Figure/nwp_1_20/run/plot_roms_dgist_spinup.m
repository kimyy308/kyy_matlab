...
inputdir = strcat(['/scratch/snu01/kimyy/roms_nwp/nwp_1_20/input/',testname,'/spinup/',num2str(year,'%04i'),'/']);
outputdir = strcat(['/scratch/snu01/kimyy/roms_nwp/nwp_1_20/output/',testname,'/spinup/',num2str(year,'%04i'),'/']); % % where data files are
