...
load /scratch/snu01/kimyy/Dropbox/source/matlab/Common/Figure/jet_mod
run('/scratch/snu01/kimyy/Dropbox/source/matlab/Common/Figure/bwr_map')  % % set colormap (blue and white)
...
m_quiver_hor_ref_vec_x_range = 180:185;
m_quiver_hor_ref_vec_y_range = 378:383;
