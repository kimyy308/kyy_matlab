...
% % set part of the m_quiver parameter 
    param.m_quiver_vector_size = 5;
    param.m_quiver_ref_u_value = 0.3;
...
%             param.colorbar_lev = [34.35 34.55]; % RCM-CNH
%             param.colorbar_lev = [33.65 33.7]; % RCM-ECV, RCM-CMC
%             param.colorbar_lev = [32.5 33]; % RCM-ACC
            param.colorbar_lev = [33.8 34.1]; % v04
        case('SSH')
            param.varname = 'zeta';
        ...
        case('vert_temp')
            ...
            param.colorbar_lev = [0 15];
        case('vert_salt')
            param.varname = 'salt';
            param.colorbar_title = ' ';
            param.colormap_style = jet;
            param.colorbar_lev = [33 35];
        case('vert_u')
            param.varname = 'u';
        ...
        case('vert_temp_nogrd')
            param.varname = 'temp';
            param.colorbar_title = '(^oC)';
            param.colormap_style = jet;
        case('vert_salt_nogrd')
            param.varname = 'salt';
            param.colorbar_title = ' ';
            param.colormap_style = jet;
        case('vert_rho_nogrd')
...
%             param.colorbar_lev = [-4 4]; % annual
            param.colorbar_lev = [-6*10e-8 6*10e-8]; % annual
            param.colormap_style = cmap.bwr_map;
        otherwise
            param.varname = tmp.variable;
            param.colorbar_title = ' ';
...
param.m_pcolor_ref_text_x_location = 134;
param.m_pcolor_ref_text_y_location = 49;
...
param.m_contour_title_fontsize = 15;
param.m_contour_label_fontsize = 10;
...
param.m_quiver_title_fontsize = 15;
% param.m_quiver_x_interval = 5;
% param.m_quiver_y_interval = 5;
param.m_quiver_x_interval = 7;
param.m_quiver_y_interval = 7;
param.m_quiver_wind_x_interval = 15;
param.m_quiver_wind_y_interval = 15;
...
param.m_quiver_ref_text_x_location = 134;
param.m_quiver_ref_text_y_location = 46;
