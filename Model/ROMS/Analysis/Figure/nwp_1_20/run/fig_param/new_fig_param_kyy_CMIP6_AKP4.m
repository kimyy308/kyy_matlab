% % this script is for Around Korean Peninsula region figure
% %  Updated 07-Dec-2021 by Yong-Yub Kim  (structure)
...
if (strcmp(tmp.testname, 'CNRM-CM6-1-HR'))
    param.m_quiver_x_interval = 4;
    param.m_quiver_y_interval = 4;
end
...
% % set gcf parameter
param.hor_paper_size_x = GCM_grid.domain(2)-GCM_grid.domain(1);
param.hor_paper_size_y = GCM_grid.domain(4)-GCM_grid.domain(3);
tmp.halt = 1;
while(tmp.halt)
