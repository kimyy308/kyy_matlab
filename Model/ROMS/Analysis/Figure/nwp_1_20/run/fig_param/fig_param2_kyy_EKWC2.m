...
%             param.colorbar_lev = [-4 4]; % annual
            param.colorbar_lev = [0 7]; % winter
%             param.colormap_style = cmap.bwr_map;
        case('Vwind')
            param.varname = 'Vwind';
            param.colorbar_title = '(m/s)';
%             param.colorbar_lev = [-4 4]; % annual
            param.colorbar_lev = [-7 0]; % winter
%             param.colormap_style = cmap.bwr_map;
        case('u')
            param.varname = 'u';
            param.colorbar_title = '(m/s)';
            param.colorbar_lev = [-0.4 0.4]; % winter
        case('v')
            param.varname = 'v';
            param.colorbar_title = '(m/s)';
            param.colorbar_lev = [-0.4 0.6]; % winter
        case('wstrcurl')
