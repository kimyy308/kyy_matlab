...
if (exist('lonlat' , 'var') == 1)
    ...
    while(halt)
        if (hor_paper_size_x > 500 || hor_paper_size_y > 500)
            ...
            hor_paper_size_x = hor_paper_size_x * 1.1; 
            hor_paper_size_y = hor_paper_size_y * 1.1;
        end
    end
