% % this script is for East/Japan Sea region figure
% %  Updated 22-Jun-2018 by Yong-Yub Kim
% %  Updated 22-Aug-2018 by Yong-Yub Kim (get colormap in linux is available)
...
elseif (strcmp(system_name,'GLNXA64'))    % % for linux
    load /home/kimyy/Dropbox/source/matlab/Common/Figure/jet_mod  % % set colormap (jet_modified)
    run('/home/kimyy/Dropbox/source/matlab/Common/Figure/bwr_map')  % % set colormap (blue and white)
end
% for i = 1:3
...
calendarname{7} = 'July'; calendarname{8} = 'August'; calendarname{9} = 'September'; calendarname{10} = 'October'; calendarname{11} = 'November'; calendarname{12} = 'December'; calendarname{17} = 'mean';
