function status=plot_seo_ROMS_monthly_hor_t_uv2(testname, outfile, filedir, section, tempyear,inputmonth, shadlev, conlev, var,  param_script)
% clear all;close all;
%==========================================================================
% % % vert_param;
...
%     titlename = strcat('T, surf (',char(calendarname(tempmonth)), ', ', num2str(tempyear),'-',num2str(tempyear2),')');
    titlename = strcat('T, surf (',char(calendarname(tempmonth)), ', ', num2str(tempyear),')');
else  
