...
month = [2]; % % put month which you want to plot [month month ...]
...
% 
    ...
    status=plot_ROMS_monthly_hor_t_uv(testname, hor_tuv_file, outputdir, [127 134 35 43 0 0], tempyear,month, [0 15], [-20 2 5 100], 'temp',  'fig_param_kyy_EKB_10');                                 
    
%     hor_tuv_file =[figdir, 'EJS/EK/', 'hor_temp/', 'EK_hor_uv_0000m']; % % ~/SUV_EJS_testname_year_month.jpg
...
%     status=plot_ROMS_monthly_hor_t_uv(testname, hor_tuv_file, outputdir, [127 134 35 43 -50 -50], tempyear,month, [0 15], [-20 2 5 100], 'temp',  'fig_param_kyy_EKB_10');                                 
%  
