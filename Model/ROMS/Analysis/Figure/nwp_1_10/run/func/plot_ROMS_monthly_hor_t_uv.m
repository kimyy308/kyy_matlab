function status=plot_ROMS_monthly_hor_t_uv(testname, outfile, filedir, section, tempyear, inputmonth, shadlev, conlev, var,  param_script)
% clear all;close all;
%==========================================================================
...
for monthij=1:length(inputmonth)
    ...
    ekwc_temp=cut_data2(:,17)
    tminind=find(ekwc_temp<5)
    ekwc_temp(tminind(1))
    cut_lat_rho(tminind(1),17)
