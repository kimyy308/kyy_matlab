function status=plot_ROMS_monthly_surface_UV_diff(testname, outfile, filedir, section, tempyear, inputmonth, shadlev, conlev, var, param_script)
   % %  Updated 08-Jun-2018 by Yong-Yub Kim  --> temporary code

lonlat = section(1:4);   
run(param_script);
tempmonth=inputmonth(1);
filename = strcat(filedir,'\..\8586\', ...
                testname, '_monthly_', num2str(8586,'%04i'), '_', num2str(tempmonth,'%02i'), '.nc');
