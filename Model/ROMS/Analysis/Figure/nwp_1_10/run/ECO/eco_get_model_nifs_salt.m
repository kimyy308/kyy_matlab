...
load(['E:\Data\Observation\NIFS\xls\eco_NIFS_salt_trend_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat']);
...
% % for windows
    ...
    param_script ='C:\Users\kyy\Dropbox\source\matlab\Model\ROMS\Analysis\Figure\nwp_1_10\run\fig_param\fig_param_kyy_eco.m'
...
save(['E:\Data\Observation\NIFS\xls\',testname,'_eco_nwp_1_10_salt_trend_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'], 'MODEL6', 'NIFS6');
