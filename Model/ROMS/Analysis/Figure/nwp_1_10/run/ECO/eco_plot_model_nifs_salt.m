...
inputyear = [1980:1985]; % % put year which you want to plot [year year ...]
...
load(['E:\Data\Observation\NIFS\xls\',testname,'_eco_nwp_1_10_salt_trend_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat']);
...
%         msaltplot2=plot(xData,line_trend2,'Color','r')
        ...
        txt2=text(xData(10), min(meanplotlev)+1 ,['RMSD = ', num2str(round(mean_salt_RMS,2)), ', '], 'FontSize', m_quiver_ref_text_fontsize); 
        txt3=text(xData(18), min(meanplotlev)+1 ,['bias = ', num2str(round(mean_salt_bias,2))], 'FontSize', m_quiver_ref_text_fontsize); 
