...
dirs.figrawdir =strcat('D:\Research\Ph_D_course\2021_Particle tracking of the walleye pollock\02_review\Review_round_03\figure_review_round_03\'); % % where figure files will be saved
...
figs.tifname = [dirs.figrawdir, 'Fig04.tif'];
