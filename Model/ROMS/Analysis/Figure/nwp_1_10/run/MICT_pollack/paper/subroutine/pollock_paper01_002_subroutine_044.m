...
%                         egg_mask(egg_mask==0)=NaN;
            ...
            all_egg_mask=squeeze(ncread(ncname, 'mask_par', [1 1 1 ind_checktime], [inf inf inf 1])).*vel_mask;
            
            SK_EEZ_egg_mask=all_egg_mask.*SK_EEZ_mask;
            NK_EEZ_egg_mask=all_egg_mask.*NK_EEZ_mask;
            RU_PR_EEZ_egg_mask=all_egg_mask.*RU_PR_EEZ_mask;
            RU_SH_EEZ_egg_mask=all_egg_mask.*RU_SH_EEZ_mask;
            JP_EEZ_egg_mask=all_egg_mask.*JP_EEZ_mask;
...
%                 set(axRH,'ycolor','b', 'box', 'off', 'FontSize',15);
    ...
    title(['eggs (elapsed ', num2str(temp_checktime, '%02i'), 'd)', ',', num2str(min(allyear),'%04i'),'-',num2str(max(allyear),'%04i'), ...
