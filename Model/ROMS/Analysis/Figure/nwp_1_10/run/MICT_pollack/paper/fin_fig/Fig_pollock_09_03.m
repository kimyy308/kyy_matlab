...
tifname = [figrawdir, 'Fig09_03.tif'];
...
%             vel_mask(vel_mask<=500)=1;
            vel_mask(isfinite(vel_mask))=1;
            vel_mask(lat_RCM>39)=NaN;
        else
...
xlabel('Distance (km)')
xlim([0 200])
ylimmin=0; ylimmax=500; ylim([ylimmin ylimmax]); txtupper=(ylimmax+abs(ylimmin))*1800/2000; txtlow=(ylimmax+abs(ylimmin))*1500/2000;  
grid minor;
set(ax{testnameind,1}, 'fontsize', m_grid_fontsize) 
txt{testnameind,1}=text(200*300/500, txtlow, '(A) 83-87', 'FontSize', m_grid_fontsize-2); 
txt{testnameind,1}=text(200*300/500, txtupper, '15 days', 'FontSize', m_grid_fontsize-2); 

set(ax{testnameind,1}, 'XAxisLocation', 'top')
set(ax{testnameind,1}, 'XTick',[100  200])
set(ax{testnameind,1}, 'XTicklabel', {'100', '200'})
...
grid minor;
set(ax{testnameind,1}, 'fontsize', m_grid_fontsize) 
txt{testnameind,1}=text(200*300/500, txtlow, '(B) 88-92', 'FontSize', m_grid_fontsize-2); 
txt{testnameind,1}=text(200*300/500, txtupper, '15 days', 'FontSize', m_grid_fontsize-2); 
...
ylimmax=400;
ylimmin=-400;
txtupper=(ylimmax+abs(ylimmin))*1260/1400 - abs(ylimmin);
txtlow=(ylimmax+abs(ylimmin))*1050/1400- abs(ylimmin);
ylim([ylimmin ylimmax]); 
grid minor;
set(ax{testnameind,1}, 'fontsize', m_grid_fontsize) 
% txt{testnameind,1}=text(200*300/500, txtlow, '(C) B-A', 'FontSize', m_grid_fontsize-2); 
txt{testnameind,1}=text(200*300/500, txtlow, '(C) (B)-(A)', 'FontSize', m_grid_fontsize-3); 
txt{testnameind,1}=text(200*300/500, txtupper, '15 days', 'FontSize', m_grid_fontsize-2); 
...
grid minor;
set(ax{testnameind,1}, 'fontsize', m_grid_fontsize) 
txt{testnameind,1}=text(200*300/500, txtlow, '(D) 83-87', 'FontSize', m_grid_fontsize-2); 
txt{testnameind,1}=text(200*300/500, txtupper, '30 days', 'FontSize', m_grid_fontsize-2); 
...
grid minor;
set(ax{testnameind,1}, 'fontsize', m_grid_fontsize) 
txt{testnameind,1}=text(200*300/500, txtlow, '(E) 88-92', 'FontSize', m_grid_fontsize-2); 
txt{testnameind,1}=text(200*300/500, txtupper, '30 days', 'FontSize', m_grid_fontsize-2); 
...
grid minor;
set(ax{testnameind,1}, 'fontsize', m_grid_fontsize) 
% txt{testnameind,1}=text(200*300/500, txtlow, '(F) E-D', 'FontSize', m_grid_fontsize-2); 
txt{testnameind,1}=text(200*300/500, txtlow, '(F) (E)-(D)', 'FontSize', m_grid_fontsize-3); 
txt{testnameind,1}=text(200*300/500, txtupper, '30 days', 'FontSize', m_grid_fontsize-2); 
...
sum(sum_data_with_dist_late_15d(1:12)/sum(sum_data_with_dist_early_15d(1:12)))
sum(sum_data_with_dist_late_30d(1:12)/sum(sum_data_with_dist_early_30d(1:12)))
