...
tifname = [figrawdir, 'Fig02_02.tif'];
...
txt{testnameind,1}=m_text(127.3, 43, '(A) OISST', 'FontSize', m_grid_fontsize+4); 
...
caxis(caxisval);
colormap(ax{testnameind,3},jet_mod);
txt{testnameind,1}=m_text(127.3, 43, '(B) Reanalysis', 'FontSize', m_grid_fontsize+4); 
...
save ('D:\research\Ph_D_course\2021_Particle tracking of the walleye pollock\data_dryad\Data02_02_SST.mat', ...
