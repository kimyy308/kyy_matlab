...
tifname = [figrawdir, 'Fig12_02.tif'];
...
% % projection
testnameind=1;
sb1=subplot(5,2,[1 2]);  % Auto-fitted to the figure.
...
% % projection
testnameind=2;
sb1=subplot(5,2,[3 4]);  % Auto-fitted to the figure.
pos_sb{testnameind,1}=get(sb1, 'pos'); % Get the position.
...
txt{testnameind,1}=text(1983, 52.5, '(B) EAWMI', 'FontSize', m_grid_fontsize); 
...
% % projection
sb1=subplot(5,2,[5 6]);  % Auto-fitted to the figure.
pos_sb{testnameind,1}=get(sb1, 'pos'); % Get the position.
pos_sb{testnameind,1} = pos_sb{testnameind,1} + correction_upper_fig+ correction_large_fig + [0,0,0,0];
delete(sb1); % Delete the subplot axes
ax{testnameind,1}=axes;
...
axis tight 
ylim(ax{testnameind,1}, [-1,1].*dist_value)
set(ax{testnameind,1},'ycolor','k', 'box', 'off', 'FontSize',m_grid_fontsize);
xlabel(ax{testnameind,1}, 'Year');
...
% % projection
sb1=subplot(5,2,[7 8]);  % Auto-fitted to the figure.
pos_sb{testnameind,1}=get(sb1, 'pos'); % Get the position.
pos_sb{testnameind,1} = pos_sb{testnameind,1} + correction_upper_fig+ correction_large_fig + [0,0,0,0];
delete(sb1); % Delete the subplot axes
ax{testnameind,1}=axes;
...
mslplot{testnameind,2}=bar(AOI_year_yearly, yearly_mov_dist_lon_mean.*dist_value, 'FaceColor', [0.6 0.6 0.6], 'parent',ax{testnameind,1});
hold on
mslplot{testnameind,1}=plot(AOI_year_yearly(1:5), dist_lon_half_1.*dist_value, 'k','parent',ax{testnameind,1});
mslplot{testnameind,3}=plot(AOI_year_yearly(6:10), dist_lon_half_2.*dist_value, 'k','parent',ax{testnameind,1});
ylabel(ax{testnameind,1},'Distance (km)')
...
% txt{testnameind,1}=text(480/720*10+1982, 2.5.*dist_value, '(D) Zonal travel distance of the individuals', 'FontSize', m_grid_fontsize); 
txt{testnameind,1}=text(1986, 2.5.*dist_value, '(D) Zonal travel distance of the individuals', 'FontSize', m_grid_fontsize); 
...
% % projection
sb1=subplot(5,2,[9 10]);  % Auto-fitted to the figure.
pos_sb{testnameind,1}=get(sb1, 'pos'); % Get the position.
pos_sb{testnameind,1} = pos_sb{testnameind,1} + correction_upper_fig+ correction_large_fig + [0,0,0,0];
delete(sb1); % Delete the subplot axes
ax{testnameind,1}=axes;
...
mslplot{testnameind,2}=bar(AOI_year_yearly, sum_ts_egg_mask, 'FaceColor', [0.6 0.6 0.6], 'parent',ax{testnameind,1});
hold on
mslplot{testnameind,1}=plot(AOI_year_yearly(1:5), egg_half_1, 'k','parent',ax{testnameind,1});
mslplot{testnameind,3}=plot(AOI_year_yearly(6:10), egg_half_2, 'k','parent',ax{testnameind,1});
...
txt{testnameind,1}=text(1986, 500, '(E) Remained individuals in southern nursery', 'FontSize', m_grid_fontsize); 
