...
% % %         switch region
        ...
        for folding=1:1
            ...
            fig_flags{7,2}=0;  % 'wind diff plot between 80s and later';
...
%             fig_flags{15,2}=1;  % 'probability plot for pollock spwaning ground (hovmoller)';
            ...
            fig_flags{31,2}=0;  %'SST plot';
            fig_flags{32,2}=0;  %'OISST plot';
            ...
            fig_flags{56,2}=0;  %'SST RMSE plot';
            ...
            fig_flags{63,2}=2;  %'particle latitude boxplot (elapsed ?? days)';
        end
        
%         for flagi=1:100
%             fig_flags{flagi,2}=0;
%         end
%             fig_flags{14,2}=2;  %'vec
%         fig_flags{56,2}=2;  %'SST RMSE plot';
