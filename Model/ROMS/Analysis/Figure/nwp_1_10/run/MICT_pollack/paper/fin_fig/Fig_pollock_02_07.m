...
tifname = [figrawdir, 'Fig02_07.tif'];
...
txt{testnameind,1}=m_text(129.8, 46.5, '(83-87)', 'FontSize', m_grid_fontsize+4); 
...
txt{testnameind,1}=m_text(127.3, 48, '(B) OISST', 'FontSize', m_grid_fontsize+4); 
txt{testnameind,1}=m_text(129.8, 46.5, '(88-92)', 'FontSize', m_grid_fontsize+4); 
...
txt{testnameind,1}=m_text(127.3, 48, '(C) Reanalysis', 'FontSize', m_grid_fontsize+4); 
txt{testnameind,1}=m_text(129.8, 46.5, '(83-87)', 'FontSize', m_grid_fontsize+4); 
...
txt{testnameind,1}=m_text(127.3, 48, '(D) Reanalysis', 'FontSize', m_grid_fontsize+4); 
txt{testnameind,1}=m_text(129.8, 46.5, '(88-92)', 'FontSize', m_grid_fontsize+4); 
