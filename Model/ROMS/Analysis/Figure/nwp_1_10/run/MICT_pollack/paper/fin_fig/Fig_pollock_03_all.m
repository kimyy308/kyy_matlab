...
% 
% catch_data = readtable("Z:\내 드라이브\research\Ph_D_course\Particle tracking of the walleye pollock\catch\어업별_품종별_통계_20210622004605.xlsx", opts, "UseExcel", false);
% 
% clear opts
...
data_range=9:32;
year = table2array(catch_data(2,data_range));
...
jpgname = 'Z:\내 드라이브\research\Ph_D_course\Particle tracking of the walleye pollock\figure\paper\Fig04_03.jpg';
startind=1;
% endind=length(year);
endind=23;
