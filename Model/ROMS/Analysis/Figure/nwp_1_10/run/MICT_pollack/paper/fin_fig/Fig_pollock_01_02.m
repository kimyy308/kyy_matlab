...
hold off
tifname = 'Z:\내 드라이브\research\Ph_D_course\Particle tracking of the walleye pollock\figure\paper\Fig01_01_02.tif';
...
% m_line(JP_EEZ_polygon(:,1), JP_EEZ_polygon(:,2), 'LineStyle', '--')
hold off
tifname = 'Z:\내 드라이브\research\Ph_D_course\Particle tracking of the walleye pollock\figure\paper\Fig01_02_02.tif';
print('-dtiff','-r500',tifname); RemoveWhiteSpace([], 'file', tifname);
close all