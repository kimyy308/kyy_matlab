% %  Updated    14-Jun-2021 by Yong-Yub Kim   % # of eggs -> # of individuals
    ...
    for yearij = 1:length(allyear)
        ...
        for monthij = 1:length(inputmonth)
            ...
            if(exist('curl_mask')==0)
                ...
                vel_polygon=[0, 0; 0, 39; 360, 39; 360,0];
                vel_mask = double(inpolygon(lon_rho,lat_rho,vel_polygon(:,1),vel_polygon(:,2)));
                
                h = ncread(ncname, 'h');
                vel_mask2=h;
                vel_mask2(vel_mask2>500)=NaN;
                vel_mask2(vel_mask2<=500)=1;
                
                vel_mask=vel_mask.*vel_mask2;
            end
