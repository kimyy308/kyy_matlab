...
hold off
tifname = 'D:\research\Ph_D_course\2021_Particle tracking of the walleye pollock\figure\paper\Fig01_01_04.tif';
...
% pos_sb=get(ax1, 'pos'); % Get the position.
% ax2=axes('position',pos_sb);
% m_grid('fontsize', m_grid_fontsize-7, 'tickdir', m_grid_tickdir_type, 'box', m_grid_box_type);
% colormap([0 0 0.5]);
...
m_grid('fontsize', m_grid_fontsize-7, 'tickdir', m_grid_tickdir_type, 'box', m_grid_box_type);
hold off
tifname = 'D:\research\Ph_D_course\2021_Particle tracking of the walleye pollock\figure\paper\Fig01_02_06.tif';
print('-dtiff','-r500',tifname); RemoveWhiteSpace([], 'file', tifname);
close all