...
catch_data = readtable("D:\research\Ph_D_course\2021_Particle tracking of the walleye pollock\catch\어업별_품종별_통계_20210219_명태_노가리.xlsx", opts, "UseExcel", false);
...
jpgname = 'D:\Research\Ph_D_course\2021_Particle tracking of the walleye pollock\02_review\Review_round_04\figure_review_round_03\final\Korean\Fig02_02.tif';
startind=1;
% endind=length(year);
endind=10;
...
set(pollock_adult.plot,'LineStyle','-', 'Marker', 'o','LineWidth',3, 'color', 'b');
% set(pollock_adult.halfplot1,'LineWidth',3, 'color', 'b');
% set(pollock_adult.halfplot2,'LineWidth',3, 'color', 'b');
set(pollock_juvenile.plot,'LineStyle','-','Marker','^','LineWidth',3, 'color', 'r');
