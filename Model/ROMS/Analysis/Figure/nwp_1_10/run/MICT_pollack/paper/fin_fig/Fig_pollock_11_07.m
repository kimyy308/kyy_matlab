...
tifname = [figrawdir, 'Fig11_07.tif'];
...
% AOI_value=lowpass(AOI_value, 1/60, 1, 'Steepness', 0.99);  % phase correction is applied automatically, but butterworth isn't.
...
txt{testnameind,1}=text(1983, 1.2, 'AOI', 'FontSize', m_grid_fontsize); 
...
txt{testnameind,1}=text(1982.5 , 0.5.*dist_value, '    Meridional travel distance of the individuals', 'FontSize', m_grid_fontsize); 
