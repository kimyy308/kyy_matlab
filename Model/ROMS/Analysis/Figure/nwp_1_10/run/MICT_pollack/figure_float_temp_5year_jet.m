...
%             heatmap3=1-(nyear-1)*1/(length(totyear)-1);
    ...
    %     legend([p1 p2 p3],{[num2str(totyear(1)),'-',num2str(totyear(1)+4)],[num2str(totyear(2)),'-',num2str(totyear(2)+4)],[num2str(totyear(3)),'-',num2str(totyear(end)+4)]},'location','north','orientation','horizontal')
        ...
        if (include_std==1)
            savename = [savepath,'jet_ltrans_temp_std_',num2str(mean_range,'%02i'),'year_',num2str(totyear(1),'%04i'),'_',num2str(totyear(end),'%04i'),'_',month,'.png'];
        else
            savename = [savepath,'jet_ltrans_temp_',num2str(mean_range,'%02i'),'year_',num2str(totyear(1),'%04i'),'_',num2str(totyear(end),'%04i'),'_',month,'.png'];
        end
