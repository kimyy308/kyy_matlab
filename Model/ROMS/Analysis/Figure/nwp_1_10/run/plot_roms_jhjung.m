...
year = [1980]; % % put year which you want to plot [year year ...]
...
figdir =strcat('E:\Data\Model\ROMS\nwp_1_10\figure\',testname,'\'); % % where figure files will be saved
inputdir = strcat('E:\Data\Model\ROMS\nwp_1_10\output\', testname, '\'); % % where data files are
...
% % % % % %  plot EJS
lonlat_EJS = [115 144 25 52]; % [lon_start lon_end lat_start lat_end]
for i=1:length(year)   
    tempyear=year(i);
    inputdir2 = [inputdir,num2str(tempyear,'%04i')];
    ...
    status=plot_ROMS_monthly_surface_data(testname, sstfile, inputdir2, lonlat_EJS, tempyear, month, ...
...
% 
    ...
    status=plot_ROMS_monthly_surface_data(testname, sssfile, inputdir2, lonlat_EJS, tempyear, month, ...
                                    [30 35], 30:1:35, 'SSS', 'fig_param_kyy_EJS');
%                                 
%     % %  plot SSH (EJS)
...
% 
    ...
    status=vec_ROMS_monthly_surface_UV(testname, suvfile, inputdir2, lonlat_EJS, tempyear, month, ...
