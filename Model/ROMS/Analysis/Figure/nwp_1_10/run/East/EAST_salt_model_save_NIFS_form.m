...
save(['E:\Data\Observation\NIFS\xls\',testname,'_nwp_1_10_salt_trend_',num2str(min(inputyear),'%04i'),'_',num2str(max(inputyear),'%04i'),'.mat'], 'MODEL6', 'NIFS6');
