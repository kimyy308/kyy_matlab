...
% %  Updated 20-Dec-2021 by Yong-Yub Kim, wind parameter

if (exist('refdepth' , 'var') ~= 1)
% % set part of the m_quiver parameter 
    param.m_quiver_vector_size = 4.5;
    param.m_quiver_ref_u_value = 0.5;
    param.m_quiver_wind_vector_size = 0.2;
    param.m_quiver_ref_u_diff_value = 0.1;
elseif (refdepth >= -100)
...
[cmap.bwr_map, tmp.error_status] = Func_0009_get_colormaps('bwr', tmp.dropboxpath);
[cmap.jet_mod, tmp.error_status] = Func_0009_get_colormaps('jet_mod', tmp.dropboxpath);

param.colorbar_fontsize = 15;
...
%             param.colorbar_lev = [-4 4]; % annual
        ...
        case('NTI')
            param.varname = 'NTI';
            param.colorbar_title = 'NTI';
            param.colorbar_lev = [0 150];
        otherwise
...
param.m_quiver_x_interval = 3;
param.m_quiver_y_interval = 3;
...
param.m_quiver_ref_v_diff_value = param.m_quiver_ref_u_diff_value/10000.0;
param.m_quiver_ref_text = [num2str(param.m_quiver_ref_u_value),' m/s'];
param.m_quiver_ref_diff_text = [num2str(param.m_quiver_ref_u_diff_value),' m/s'];
