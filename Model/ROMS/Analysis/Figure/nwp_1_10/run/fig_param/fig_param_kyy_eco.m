...
calendarname{13} = 'Spring'; calendarname{14} = 'Summer'; calendarname{15} = 'Autumn'; calendarname{16} = 'Winter'; calendarname{17} = 'Yearly';
...
m_quiver_ref_vec_x_range = 390:392;
m_quiver_ref_vec_y_range = 745:747;
m_quiver_ref_text = '0.5 m/s';
m_quiver_ref_text_fontsize = 15;
m_quiver_ref_text_x_location = 126.33;
m_quiver_ref_text_y_location = 33.3;
