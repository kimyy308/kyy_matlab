...
% http://iridl.ldeo.columbia.edu/SOURCES/.NOAA/.NODC/.WOA01/.Grid-1x1/.Seasonal/.an/
%
no3_seas_data=[woa_dir,'nitrate_seasonal_1deg_2005.nc'];
no3_ann_data=[woa_dir,'nitrate_annual_1deg_2005.nc'];
chla_seas_data=[woa_dir,'chla_woa2001.cdf'];
NO3min=1;
%
%
...
if (makeoa)
  ext_tracers(oaname,no3_seas_data,no3_ann_data,...
              'n00an1','n1316an1','NO3','no3_time','Zno3',Roa);
end
%
...
figure
test_clim(ininame,grdname,'chlorophyll',1,coastfileplot)
figure
test_clim(ininame,grdname,'phytoplankton',1,coastfileplot)
%
% End
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
