function test_bry(bry_file,grid_file,tracer,l,obc,Vtransform,Vstretching)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
for obcndx=1:4
  if obc(obcndx)==1
    ...
    [Nz,Nx]=size(temp);
    z=squeeze(zlevs(Vtransform,Vstretching,topo,0*topo,theta_s,theta_b,hc,Nz,'r'));
    x1=0*topo;
    for i=2:Nx
