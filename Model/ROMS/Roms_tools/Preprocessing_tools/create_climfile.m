...
kgrid=1;
[sc_w,Cs_w]=stretching(Vstretching, theta_s, theta_b, hc, N, kgrid,'true');
kgrid=0;
[sc_r,Cs_r]=stretching(Vstretching, theta_s, theta_b, hc, N, kgrid,'true');

% % just only for vtransform =1
