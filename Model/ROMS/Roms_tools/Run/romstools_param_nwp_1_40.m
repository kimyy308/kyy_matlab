...
%
ROMS_title  = 'NorthPacific Model 1/40';
...
grdname=['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_40/input/test01/spinup/1980/roms_grid_nwp_1_40_test01.nc'];
smoothname=['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_40/input/test01/spinup/1980/roms_grid_nwp_1_40_test01.nc'];
...
clmname=['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_40/input/test01/spinup/1980/','roms_nwp_clim.nc'];
% ininame=[ROMS_files_dir,'roms_nwp_ini2_test27.nc'];
ininame=['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_40/input/test01/spinup/1980/','roms_nwp_ini2_test01.nc'];
oaname =['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_40/input/test01/spinup/1980/','roms_nwp_oa.nc'];    % oa file  : intermediate file not used
                                             %            in roms simulations
...
frcname=['/data1/kimyy/Model/ROMS/roms_nwp/nwp_1_40/input/test01/spinup/1980/nwp_1_20_',num2str(Ymax,'%04i'),'_tides.nc'];
