...
% roms grid
grd_file = '/home/coast/roms/eas/grid/roms_eas_grid8.nc';
N = 20; % Number of vertical levels

% the new netcdf forcing file - river data will be appended
Fname = '/home/coast/roms/eas/river/roms_half_rivers.nc'; 

% load the river flow data structure
Rname = '/home/coast/roms/eas/river/eas_rivers_discharge';
load(Rname)
if ~exist('River')
