...
% % 'QJ' option is  unavailable in MATLAB 2017b
% C.Icst=griddata(rlon,rlat,x,C.lon,C.lat,method, {'QJ'});
% C.Jcst=griddata(rlon,rlat,y,C.lon,C.lat,method, {'QJ'});  

C.Icst=griddata(rlon,rlat,x,C.lon,C.lat);
C.Jcst=griddata(rlon,rlat,y,C.lon,C.lat);
