    ...
    switch var_model
        case {'TEMP', 'SALT', 'SSH', 'UVEL', 'VVEL', 'diatChl', 'diazChl', 'spChl'...
               ...
               'diatFe', 'diatP', 'diatSi', 'diaz_agg', 'diaz_Nfix', 'diazFe', 'diazP', ...
                ...
                'TEMPCLINE', 'NO3CLINE', 'UVEL55', 'VVEL55', 'TEMP145', 'UVEL145', ...
                'VVEL145', 'NO3145', 'PO4145', 'Fe145', 'mul_VVEL_NO3', 'mul_WVEL_NO3','mul_UVEL_NO3', ...
                'CaCO3_FLUX_100m', 'CO3', 'DIC_ALT_CO2', 'DOC', 'DpCO2', 'DpCO2_ALT_CO2', 'FG_CO2', ...
                'pCO2SURF', 'PH', 'POC_FLUX_IN', 'POC_PROD', ...
                'Jint_100m_NO3', 'tend_zint_100m_NO3', 'subt_tend_zint_100m_NO3_Jint_100m_NO3', 'SHF'}
        ...
        case {'AODDUST', 'AODVIS', 'dst_a1SF', 'dst_a2SF', 'dst_a3SF', ...
                ...
                'T', 'U850', 'UBOT', 'V850', 'VBOT', 'AEROD_v', ...
                'SFCO2', 'CLDTOT'}
            component='atm';
        case {'DSTFLXT', 'DSTDEP', 'DSL', 'QSOIL', 'TWS', 'NPP', 'GPP', 'TOTVEGC', ...
                'COL_FIRE_CLOSS', 'COL_FIRE_NLOSS', 'FIRE', ...
            'FPSN', 'SOILICE', 'SOILLIQ', 'TOTSOILICE', 'TOTSOILLIQ', ...
            'RAIN', 'QSOIL_ICE', 'QRUNOFF', 'QOVER', 'QRGWL', ...
            'QH2OSFC', 'NEP', 'SOILWATER_10CM', 'FAREA_BURNED','NFIRE','Q2M','RH2M','SNOW','TLAI', 'TREFHT'} %TOTVEGC, FIRE
            component='lnd';
        case {'aice', 'sithick'}
            component='ice';
