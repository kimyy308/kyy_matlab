function [p1, p2, z, za, zb] = Func_0036_corr_diff_ttest(ra, rb, na, nb)
%[p, z, za, zb] = corr_rtest(ra, rb, na, nb)
%
% http://personality-project.org/r/html/r.test.html
%
...
% Modified by Y-Y. Kim, 2024/03/12 (for 2-dimensional data)
