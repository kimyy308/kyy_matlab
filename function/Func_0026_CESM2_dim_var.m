...
switch var_model
    case {'TEMP', 'SALT', 'UVEL', 'VVEL', 'diatChl', 'diazChl', 'spChl', 'PD', ...
           ...
           'diat_agg', 'diatFe', 'diatP', 'diatSi', 'diaz_agg', 'diaz_Nfix', 'diazFe', 'diazP', ...
            ...
            'spFe', 'spP', 'zooC', 'photoC_NO3_TOT', 'photoC_TOT', 'mul_VVEL_NO3', 'mul_WVEL_NO3','mul_UVEL_NO3', ...
             'CO3', 'DIC_ALT_CO2', 'DOC',    ...
                  'POC_FLUX_IN', 'POC_PROD'}
        dim='4d'; %[x, y, z, t]
    case {'dustToSed', 'SSH', 'AODDUST', 'AODVIS', 'dst_a1SF', 'dst_a2SF', 'dst_a3SF', ...
           ...
           'TOTAL_DISCHARGE_TO_OCEAN_LIQ', ...
            ...
            'AEROD_v', 'SFCO2', 'CLDTOT', 'SOILWATER_10CM', 'FAREA_BURNED', 'NFIRE','Q2M','RH2M', 'SNOW','TLAI', ...
            'CaCO3_FLUX_100m','DpCO2','DpCO2_ALT_CO2','FG_CO2','pCO2SURF','PH','Jint_100m_NO3', 'tend_zint_100m_NO3', ...
            'subt_tend_zint_100m_NO3_Jint_100m_NO3'}
        dim='3d'; % [x, y, t]
end
