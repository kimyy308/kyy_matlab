...
year = [1983:2019]; % % put year which you want to plot [year year ...]
...
figdir =strcat('D:\OneDrive - ¼­¿ï´ëÇÐ±³\MEPL\project\MICT_pollack\3rd_year\figure\AVHRR\EJS\EK\hor_temp_daily\'); % % where figure files will be saved
inputdir = strcat('E:\Data\Observation\OISST\daily\'); % % where data files are
...
%     status=plot_OISST_monthly_hor_t(testname, hor_tuv_file, inputdir, [115 164 15 52], tempyear, month, [0 30], [-20 0 10 20 30 100], 'fig_param_kyy_EKB_10');                                 
    ...
    status=plot_OISST_daily_hor_t(testname, hor_tuv_file, inputdir, lonlat_EK, tempyear, month, day, [0 15], [-20 0 2 5 10 20 30 100], 'fig_param_kyy_EKB_10');                                 
