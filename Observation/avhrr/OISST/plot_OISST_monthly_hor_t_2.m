function status=plot_OISST_monthly_hor_t_2(testname, outfile, filedir, section, tempyear,inputmonth, shadlev, conlev,  param_script)
% clear all;close all;
%==========================================================================
...
for monthij=1:length(inputmonth)
    ...
    tempmonth_2 = 1;
    filename = strcat(filedir, testname, num2str(tempyear,'%04i'),num2str(tempmonth,'%02i'), '.nc');
    ...
    data = ncread(filename,varname,[lon_min(1) lat_min(1) 1 tempmonth_2], [lon_max(1)-lon_min(1)+1 lat_max(1)-lat_min(1)+1 1 1]);  %% cut horizontal area [x,y,z] (wider than target area)
    data=squeeze(data);
